...
{
    /// <summary>
    /// Represents a transaction for V_FORMULASETITEM view.
    /// [Created by 127.0.0.1 on January,16 2009]
    /// </summary>
    public class VFormulaSetItemDAL
    {

        public VFormulaSetItemDAL()
        {
        }

        #region Constant

        /// <summary>V_FORMULASETITEM</summary>
        private const string viewName = "V_FORMULASETITEM";
        ...
        /// <summary>
        /// Gets the select statement for V_FORMULASETITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_FORMULASETITEM by specified condition is retrieved successfully.
        /// </summary>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                            ...
                            if (!Convert.IsDBNull(zRdr["MATERIALWEIGHT"])) _MATERIALWEIGHT = Convert.ToDouble(zRdr["MATERIALWEIGHT"]);
        ...
        public DataTable GetDataListByFormulaSet(double cFORMULASET, double cREFFORMULA, string orderBy, OracleTransaction trans)
        {
            return GetDataList("FORMULASET = " + DB.SetDouble(cFORMULASET) + " AND REFFORMULA " + (cREFFORMULA == 0 ? "IS NULL" : ("=" + DB.SetDouble(cREFFORMULA))), orderBy, trans);
        }
