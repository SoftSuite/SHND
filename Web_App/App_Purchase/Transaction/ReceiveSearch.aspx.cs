...
/// Remark: -
/// Description:
///    หน้ากาารทำงานข้อมูล Receive Search 
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
public partial class App_Purchase_Transaction_ReceiveSearch : System.Web.UI.Page
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        Appz.BuildCombo(this.cmbSearchOrederPlan, "PLANORDER", "NAME", "LOID", "ISPLANFOOD = 'Y'", "NAME", "เลือก", "0", false);
    ...
    {
        Response.Redirect(Constant.HomeFolder + "App_Purchase/Transaction/Receive.aspx");
    }

    protected void linkCode_Click(object sender, EventArgs e)
    {
        Response.Redirect(Constant.HomeFolder + "App_Purchase/Transaction/Receive.aspx?loid=" + ((LinkButton)sender).CommandArgument);
    }
    ...
    private void ClearSearch()
    {
        ...
        ctlReceiveDateFrom.DateValue = new DateTime();
        ctlReceiveDateTo.DateValue = new DateTime();
...
//        cmbStatus.Items.Add(new ListItem("เสร็จสิ้น", "02"));
    ...
    private void doGetList()
    {
        ...
        imbReset.Visible = (this.ctlReceiveDateFrom.DateValue.Year != 1) || (this.ctlReceiveDateTo.DateValue.Year != 1) || (this.cmbSearchMaterialClass.SelectedIndex != 0) ||
            (this.txtSearchContractCode.Text.Trim() != "") || (this.txtSearchSupplier.Text.Trim() != "") || (this.cmbSearchOrederPlan.SelectedIndex != 0) ||
            (this.cmbSearchStatusFrom.SelectedIndex != 0) || (this.cmbSearchStatusTo.SelectedIndex != 0);

        ReceiveSearchData pData = new ReceiveSearchData();
        pData.RECEIVEDATEFROM = ctlReceiveDateFrom.DateValue;
        pData.RECEIVEDATETO = ctlReceiveDateTo.DateValue;
