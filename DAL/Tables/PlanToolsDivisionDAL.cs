...
{
    /// <summary>
    /// Represents a transaction for PLANTOOLSDIVISION table.
    /// [Created by 127.0.0.1 on Febuary,16 2009]
    /// </summary>
    public class PlanToolsDivisionDAL
    {

        public PlanToolsDivisionDAL()
        {
        }

        #region Constant

        /// <summary>PLANTOOLSDIVISION</summary>
        private const string tableName = "PLANTOOLSDIVISION";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into PLANTOOLSDIVISION table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to PLANTOOLSDIVISION table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from PLANTOOLSDIVISION table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of PLANTOOLSDIVISION by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for PLANTOOLSDIVISION table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ADJQTY, CREATEBY, CREATEON, DIVISION, LOID, PLANORDERDIVISION, PLANTOOLSITEM, REQQTY, STATUS) ";
                sql += "VALUES (";
                ...
                sql += DB.SetDouble(_PLANTOOLSITEM) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for PLANTOOLSDIVISION table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "PLANTOOLSITEM = " + DB.SetDouble(_PLANTOOLSITEM) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for PLANTOOLSDIVISION table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for PLANTOOLSDIVISION table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PLANTOOLSDIVISION by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        public bool GetDataByConditions(double cDIVISION, double cPLANTOOLSITEM, OracleTransaction trans)
        {
            return doGetdata("DIVISION = " + DB.SetDouble(cDIVISION) + " AND PLANTOOLSITEM = " + DB.SetDouble(cPLANTOOLSITEM), trans);
        }
        ...
        public bool UpdateStatusByPlanOrder(double cPLANORDER, string cSTATUS, OracleTransaction trans)
        {
            ...
            try
            {
                affectedRow = DB.ExecuteNonQuery("UPDATE " + tableName + " SET STATUS = " + DB.SetString(cSTATUS) + " " +
                    "WHERE PLANTOOLSITEM IN (SELECT LOID FROM PLANTOOLSITEM WHERE PLANORDER = " + DB.SetDouble(cPLANORDER) + ")", trans);
                ret = (affectedRow > 0);
                if (!ret) _error = DataResources.MSGEU001;
                _information = DataResources.MSGIU001;
            }
