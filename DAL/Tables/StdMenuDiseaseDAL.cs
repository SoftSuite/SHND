...
{
    /// <summary>
    /// Represents a transaction for STDMENUDISEASE table.
    /// [Created by 127.0.0.1 on January,15 2009]
    /// </summary>
    public class StdMenuDiseaseDAL
    {

        public StdMenuDiseaseDAL()
        {
        }

        #region Constant

        /// <summary>STDMENUDISEASE</summary>
        private const string tableName = "STDMENUDISEASE";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into STDMENUDISEASE table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to STDMENUDISEASE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from STDMENUDISEASE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of STDMENUDISEASE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for STDMENUDISEASE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, DISEASECATEGORY, ISHIGH, ISLOW, ISNON, LOID, STDMENU) ";
                sql += "VALUES (";
        ...
        /// <summary>
        /// Gets the update statement for STDMENUDISEASE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the delete statement for STDMENUDISEASE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for STDMENUDISEASE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of STDMENUDISEASE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        public bool DeleteDataByStdMenu(double cSTDMENU, string exceptDiseasecategory, OracleTransaction trans)
        {
            return doDelete("STDMENU = " + DB.SetDouble(cSTDMENU) + (exceptDiseasecategory == "" ? "" : (" AND DISEASECATEGORY NOT IN (" + exceptDiseasecategory + ")")), trans);
        }

        public bool GetDataByConditions(double cSTDMENU, double cDISEASECATEGORY, OracleTransaction trans)
        {
            return doDelete("STDMENU = " + DB.SetDouble(cSTDMENU) + " AND DISEASECATEGORY = " + cDISEASECATEGORY.ToString(), trans);
        }
