...
{
    /// <summary>
    /// Represents a transaction for WELFAREREALSERVICE table.
    /// [Created by 127.0.0.1 on June,22 2009]
    /// </summary>
    public class WelfareRealServiceDAL
    {

        public WelfareRealServiceDAL()
        {
        }

        #region Constant

        /// <summary>WELFAREREALSERVICE</summary>
        private const string tableName = "WELFAREREALSERVICE";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into WELFAREREALSERVICE table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to WELFAREREALSERVICE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from WELFAREREALSERVICE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of WELFAREREALSERVICE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        public bool GetDataByUniq(DateTime cDATE, string cDivision, OracleTransaction trans)
        {
            return doGetdata("TO_DATE(SERVICEDATE) = " + DB.SetDateTime(cDATE) + " AND DIVISION = " + DB.SetDouble(Convert.ToDouble(cDivision)) + " ", trans);
        }
        ...
        /// <summary>
        /// Gets the insert statement for WELFAREREALSERVICE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(COUPON, CREATEBY, CREATEON, DIVISION, LOID, SERVICEDATE, TIFFIN) ";
                sql += "VALUES (";
                sql += DB.SetDouble(_COUPON) + ", ";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDouble(_DIVISION) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetDateTime(_SERVICEDATE) + ", ";
                sql += DB.SetDouble(_TIFFIN) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for WELFAREREALSERVICE table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "COUPON = " + DB.SetDouble(_COUPON) + ", ";
                sql += "DIVISION = " + DB.SetDouble(_DIVISION) + ", ";
                sql += "SERVICEDATE = " + DB.SetDateTime(_SERVICEDATE) + ", ";
                sql += "TIFFIN = " + DB.SetDouble(_TIFFIN) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for WELFAREREALSERVICE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for WELFAREREALSERVICE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of WELFAREREALSERVICE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
