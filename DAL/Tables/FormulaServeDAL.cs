...
{
    /// <summary>
    /// Represents a transaction for FORMULASERVE table.
    /// [Created by 127.0.0.1 on January,5 2009]
    /// </summary>
    public class FormulaServeDAL
    {

        public FormulaServeDAL()
        {
        }

        #region Constant

        /// <summary>FORMULASERVE</summary>
        private const string tableName = "FORMULASERVE";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into FORMULASERVE table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to FORMULASERVE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from FORMULASERVE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of FORMULASERVE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for FORMULASERVE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, FORMULASET, NAME, REFLOID, REFTABLE, WEIGHTRAW, WEIGHTRIPE) ";
                sql += "VALUES (";
                ...
                sql += (_REFLOID == 0 ? "NULL" : DB.SetDouble(_REFLOID)) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for FORMULASERVE table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "REFLOID = " + (_REFLOID == 0 ? "NULL" : DB.SetDouble(_REFLOID)) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for FORMULASERVE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for FORMULASERVE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of FORMULASERVE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        public bool GetDataByConditions(double cFORMULASET, string cNAME, OracleTransaction trans)
        {
            return doGetdata("FORMULASET = " + DB.SetDouble(cFORMULASET) + " AND NAME = " + DB.SetString(cNAME), trans);
        }
