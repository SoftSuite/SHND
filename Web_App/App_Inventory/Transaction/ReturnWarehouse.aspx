<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="ReturnWarehouse.aspx.cs" Inherits="App_Inventory_Transaction_ReturnWarehouse" Title="SHND : Transaction - Return Warehouse" %>
                        ...
                        <tr>
                            <td style="padding:5px; border-right: 1px solid; border-top: 1px solid; border-left: 1px solid; border-bottom: 1px solid; width:620px; " valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" width="600">
                                    <tr style="height:24px">
                                        ...
                                        <td style="width:130px; text-align: right; padding-right:10px">วันที่คืน :</td>
                                    ...
                                    <tr style="height:24px">
                                        ...
                                        <td style="width:170px; height: 23px;">
                                         ...
                                         <td style="width:130px; text-align: right; padding-right:10px; height: 23px;">หน่วยที่คืนคลัง :&nbsp;</td>
                                        <td style="width:170px; height: 23px;">
                            ...
                            <td style="border-right: 1px solid; border-top: 1px solid; border-left: 1px solid; border-bottom: 1px solid; padding:5px; " valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" width="235px">
                                    <tr style="height:24px;">
                                        <td style="width:80px; text-align:right; padding-right:10px; height: 24px;">
                                            สถานะ :</td> 
                                        <td style="height: 24px">
                                            <asp:TextBox ID="txtStatusRef" runat="server"  Width="120px" MaxLength="20" Readonly="True" CssClass="zTextbox-View"  ></asp:TextBox></td> 
                                    </tr>
                                </table>
                            </td>
                        </tr>
              ...
              <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"  Width="100%" DataSourceID="ReturnRequestSource" OnRowDataBound="gvMain_RowDataBound">
                        ...
                        <asp:BoundField DataField="UNITNAME" HeaderText="หน่วยนับ">
                          ...
                          <asp:TemplateField HeaderText="จำนวนที่เบิก"  >
                                <ItemTemplate>
                                    <asp:TextBox ID="txtQTY" runat="server" value = "0" CssClass="zTextboxR-View" Width="95px"   Text='<%# (Convert.IsDBNull(Eval("STOCKOUTQTY")) ? "0" : Convert.ToDouble(Eval("STOCKOUTQTY")).ToString("#,##0.00")) %>'  readonly="true" ></asp:TextBox>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="จำนวนที่คืน(ดี)" >
                                <ItemTemplate>
                                    <asp:TextBox ID="txtGOODQTY" runat="server" value = "0" CssClass="zTextboxR" Width="95px" MaxLength="10"  onkeypress=ChkInt(this) onblur="valInt(this)" onfocus="prepareNum(this)" Text='<%# (Convert.IsDBNull(Eval("QTY")) ? "0" : Convert.ToDouble(Eval("QTY")).ToString("#,##0.00")) %>'   ></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="100px" HorizontalAlign="Center"/> 
                                <HeaderStyle Width="100px" HorizontalAlign="Center" /> 
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="จำนวนที่คืน(เสีย)" >
                                <ItemTemplate>
                                    <asp:TextBox ID="txtWASTEQTY" runat="server" value = "0" CssClass="zTextboxR" Width="95px" MaxLength="10"  onkeypress=ChkInt(this) onblur="valInt(this)" onfocus="prepareNum(this)" Text='<%# (Convert.IsDBNull(Eval("WASTEQTY")) ? "0" : Convert.ToDouble(Eval("WASTEQTY")).ToString("#,##0.00")) %>'   ></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="100px" HorizontalAlign="Center"/> 
                                <HeaderStyle Width="100px" HorizontalAlign="Center" /> 
                            </asp:TemplateField>
