<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PrePatientQtyFeed.aspx.cs" Inherits="PreReport_PrePatientQtyFeed" Title="SHND : Patient Qty Feed" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">รายงานสรุปผู้ป่วยตามชนิดอาหาร
            </td>
        </tr>
        <tr>
            <td>
