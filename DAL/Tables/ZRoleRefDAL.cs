...
{
    /// <summary>
    /// Represents a transaction for ZROLEREF table.
    /// [Created by 127.0.0.1 on June,5 2009]
    /// </summary>
    public class ZRoleRefDAL
    {
        ...
        /// <summary>ZROLEREF</summary>
        private const string tableName = "ZROLEREF";
        ...
        /// <summary>
        /// Gets the insert statement for ZROLEREF table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, PARENT, ZROLE) ";
                sql += "VALUES (";
        ...
        /// <summary>
        /// Gets the update statement for ZROLEREF table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the delete statement for ZROLEREF table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for ZROLEREF table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into ZROLEREF table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to ZROLEREF table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from ZROLEREF table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of ZROLEREF by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        public bool InsertRoleRef(ArrayList cPARENT, double cZROLE, string UserID, OracleTransaction trans)
        {
            bool ret = true;
            try
            {
                ...
                foreach (object p in cPARENT)
                {
                    _PARENT = Convert.ToDouble(p);
                    doInsert(trans);
                }
            }
            catch (Exception ex)
