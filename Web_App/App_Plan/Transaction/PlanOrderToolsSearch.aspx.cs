...
/// Remark: -
/// Description:
///    หน้าการทำรายการข้อมูล PlanOrderToolsSearch
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
public partial class App_Plan_Transaction_PlanOrderToolsSearch : System.Web.UI.Page
{
    ...
    protected void gvMain_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowIndex > -1)
        {
            ...
            ((ImageButton)e.Row.Cells[2].FindControl("imbCopy")).OnClientClick = "return confirm('" + string.Format(DataResources.MSGCC001, "ข้อมูลแผนประมาณการวัสดุอุปกรณ์", e.Row.Cells[1].Text) + "')";
        }
    }
