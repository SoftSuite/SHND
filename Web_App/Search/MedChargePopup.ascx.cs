...
public partial class Search_MedChargePopup : System.Web.UI.UserControl
{
        ...
        for (int i = 0; i < gvMain.Rows.Count; i++)
        {
            if (i > -1 && gvMain.Rows[i].Cells[0].FindControl("chkSelect") != null)
            {
                ...
                if (((CheckBox)gRow.Cells[1].FindControl("chkSelect")).Checked)
                {
                    ...
                    vData.PATIENTNAME = gRow.Cells[6].Text;
                    vData.HN = gRow.Cells[5].Text;
                    vData.AN = gRow.Cells[4].Text;
                    ...
                    vData.MATERIALMASTER = Convert.ToDouble("0" + gRow.Cells[11].Text);
                    vData.MATERIALNAME = gRow.Cells[12].Text;
                    vData.COST = Convert.ToDouble("0" + gRow.Cells[15].Text);
                    vData.UNIT = Convert.ToDouble("0" + gRow.Cells[13].Text);
                    vData.UNITNAME = gRow.Cells[14].Text;
                    vData.ORDERDATE =  Convert.ToDateTime(gRow.Cells[16].Text);
    ...
    private void doGetList()
    {
        ...
        gvMain.DataSource = fFlow.GetMedChargeList(txtSearchPName.Text.Trim(), txtSearchHN.Text.Trim(), txtSearchAN.Text.Trim(),
