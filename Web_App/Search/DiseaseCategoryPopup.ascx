<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DiseaseCategoryPopup.ascx.cs" Inherits="Search_DiseaseCategoryPopup" %>
...
<asp:Panel ID="pnlDiseaseCategory" runat="server" CssClass="modalPopupSearch" style="display:none">
