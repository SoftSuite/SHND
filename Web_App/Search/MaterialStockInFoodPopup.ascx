<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MaterialStockInFoodPopup.ascx.cs" Inherits="Search_MaterialStockInFoodPopup" %>
                ...
                <fieldset style="padding:15px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="700">
                        ...
                        <tr style="height:24px">
                            <td style="width:130px; padding-right:10px; text-align:right; height: 24px;">แผนประมาณการ :</td>
                        ...
                        <tr style="height:24px">
                            <td style="width:130px; padding-right:10px; text-align:right">ชื่อวัสดุอาหาร :</td>
                            <td>
