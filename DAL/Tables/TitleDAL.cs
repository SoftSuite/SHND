...
{
    /// <summary>
    /// Represents a transaction for TITLE table.
    ...
    public class TitleDAL
    {
        ...
        private const string tableName = "TITLE";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into TITLE table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to TITLE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from TITLE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of TITLE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of TITLE by specified CODE key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of TITLE by specified NAME key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for TITLE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ACTIVE, CODE, CREATEBY, CREATEON, FULLNAME, LOID, NAME) ";
                sql += "VALUES (";
                sql += DB.SetString(_ACTIVE) + ", ";
                sql += DB.SetString(_CODE) + ", ";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetString(_FULLNAME) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for TITLE table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "FULLNAME = " + DB.SetString(_FULLNAME) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for TITLE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for TITLE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of TITLE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["FULLNAME"])) _FULLNAME = zRdr["FULLNAME"].ToString();
        ...
        public string GetName(double tloid)
        {
            return DB.ExecuteScalar(sql_name + " WHERE LOID = " + tloid).ToString();
        }
        #endregion
