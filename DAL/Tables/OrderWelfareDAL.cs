...
namespace SHND.DAL.Tables
{
    ...
    public class OrderWelfareDAL
    {
        ...
        public bool InsertCurrentData(string userID, OracleTransaction trans)
        {
            ...
            _ORDERCODE = DB.GetRunningCode(TableName, "ORDERCODE", trans);
            _CREATEBY = userID;
        ...
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(COUPON, CREATEBY, CREATEON, DESCRIPTION, DIVISION, FINISHDATE, LOID, ORDERCODE, ORDERDATE, REFCODE, REFDATE, STARTDATE, STATUS, ISTIFFIN,AMOUNT) ";
                sql += "VALUES (";
        ...
        private string sql_update
        {
            get
            {
                ...
                sql += "ISTIFFIN = " + DB.SetString(_ISTIFFIN) + ", ";
