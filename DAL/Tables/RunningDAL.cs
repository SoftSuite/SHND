...
{
    /// <summary>
    /// Represents a transaction for RUNNING table.
    /// [Created by 127.0.0.1 on Febuary,11 2009]
    /// </summary>
    public class RunningDAL
    {
        ...
        private const string tableName = "RUNNING";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into RUNNING table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to RUNNING table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from RUNNING table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of RUNNING by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for RUNNING table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CODE, DESCRIPTION, ITEM, LOID, MONTH, RUNNING, VALUE, YEAR) ";
                sql += "VALUES (";
                sql += DB.SetString(_CODE) + ", ";
                sql += DB.SetString(_DESCRIPTION) + ", ";
                sql += DB.SetString(_ITEM) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetString(_MONTH) + ", ";
                sql += DB.SetString(_RUNNING) + ", ";
                sql += DB.SetString(_VALUE) + ", ";
                sql += DB.SetString(_YEAR) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for RUNNING table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "ITEM = " + DB.SetString(_ITEM) + ", ";
                sql += "MONTH = " + DB.SetString(_MONTH) + ", ";
                sql += "RUNNING = " + DB.SetString(_RUNNING) + ", ";
                sql += "VALUE = " + DB.SetString(_VALUE) + ", ";
                sql += "YEAR = " + DB.SetString(_YEAR) + " ";
                return sql;
            }
        }

        /// <summary>
        /// Gets the delete statement for RUNNING table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for RUNNING table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of RUNNING by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["ITEM"])) _ITEM = zRdr["ITEM"].ToString();
                        if (!Convert.IsDBNull(zRdr["LOID"])) _LOID = Convert.ToDouble(zRdr["LOID"]);
                        if (!Convert.IsDBNull(zRdr["MONTH"])) _MONTH = zRdr["MONTH"].ToString();
                        if (!Convert.IsDBNull(zRdr["RUNNING"])) _RUNNING = zRdr["RUNNING"].ToString();
                        if (!Convert.IsDBNull(zRdr["VALUE"])) _VALUE = zRdr["VALUE"].ToString();
