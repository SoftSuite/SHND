<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreStockOutHosList.aspx.cs" Inherits="PreReport_PreStockOutHosList" Title="SHND : Report - Tool Stock out (Return to main warehouse)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">
                รายงานสรุปรายการวัสดุอุปกรณ์ที่ส่งคืนคลังของโรงพยาบาล</td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <table border="0" cellspacing="0" cellpadding="0" width="600px">
                    ...
                    <tr id="Tr1" runat="server" style="height:24px">
                        <td style="width:130px; padding-right:10px; height: 24px;" align="right">
                            ระหว่างวันที่ :</td>
