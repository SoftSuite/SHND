<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="OrderTransferFeed.aspx.cs" Inherits="App_Delivery_Transaction_OrderTransferFeed" Title="SHND : Transaction - Food Delivery" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">
                ข้อมูลการจัดส่งอาหารทางสายให้อาหาร</td>
        </tr>
        <tr>
            <td>
                                        ...
                                        <td align="left" colspan="11">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr style="height:20px" class='<%# Eval("CONTROL").ToString() == "" && Eval("LIMIT").ToString() == "" && Eval("INCREASE").ToString() =="" ? "zHidden" : "" %>' >
                                                    <td style="width:280px"><%# Eval("CONTROL").ToString() != "" ? "<b>ควบคุม : </b>" + Eval("CONTROL") : "" %></td>
                                                ...
                                                <tr style="height:20px">
                                                    ...
                                                    <td style="width:250px"><b>วันที่ส่ง : </b><%#Eval("DELIVERYTIME","{0:dd/MM/yyyy HH:mm:ss}") %></td>
                                                </tr>
                                            </table>
                                        </td> 
                                    </tr> 
