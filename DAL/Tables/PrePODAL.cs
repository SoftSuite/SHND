...
{
    /// <summary>
    /// Represents a transaction for PREPO table.
    /// [Created by 127.0.0.1 on Febuary,19 2009]
    /// </summary>
    public class PrePODAL
    {
        ...
        /// <summary>PREPO</summary>
        private const string tableName = "PREPO";
        ...
        public bool GetDataByUniqueKey(double cPLANMATERIALCLASS, DateTime cUSEDATE, OracleTransaction trans)
        {
            return doGetdata(" PLANMATERIALCLASS = " + DB.SetDouble(cPLANMATERIALCLASS) + " AND USEDATE = " + DB.SetDateTime(cUSEDATE), trans);
        }

        /// <summary>
        /// Returns an indication whether the current data is inserted into PREPO table successfully.
        /// </summary>
        ...
        public bool InsertCurrentData(string userID, OracleTransaction trans)
        {
            ...
            _CODE = DB.GetRunningCode("PREPO", "CODE");
            _CREATEBY = userID;
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to PREPO table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from PREPO table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPO by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPO by specified CODE key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for PREPO table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ADDRESS, BPODATE, CNAME, CODE, CREATEBY, CREATEON, FAX, LOID, PLANMATERIALCLASS, REMARKS, STATUS, TEL, USEDATE) ";
                sql += "VALUES (";
                sql += DB.SetString(_ADDRESS) + ", ";
                sql += DB.SetDateTime(_BPODATE) + ", ";
                ...
                sql += DB.SetDouble(_PLANMATERIALCLASS) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for PREPO table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "BPODATE = " + DB.SetDateTime(_BPODATE) + ", ";
                sql += "CNAME = " + DB.SetString(_CNAME) + ", ";
                sql += "CODE = " + DB.SetString(_CODE) + ", ";
                sql += "FAX = " + DB.SetString(_FAX) + ", ";
                sql += "PLANMATERIALCLASS = " + DB.SetDouble(_PLANMATERIALCLASS) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for PREPO table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for PREPO table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPO by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
