<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreWelfareQty.aspx.cs" Inherits="PreReport_PreWelfareQty" Title="SHND : Report - Welfare Qty" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="headtext">
                &nbsp;รายงานสรุปจำนวนผู้รับบริการอาหารสวัสดิการ
            </td>
        </tr>
        <tr>
            <td>
