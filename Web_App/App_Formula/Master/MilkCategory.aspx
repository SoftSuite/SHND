<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="MilkCategory.aspx.cs" Inherits="App_Formula_Master_MilkCategory" Title="SHND : Master - Milk Category" %>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr style="height:24px">
                            <td style="width:120px; text-align: right; padding-right:10px">
                                รหัส :</td>
                            <td><asp:TextBox ID="txtSearchCode" runat="server" CssClass="zTextbox" MaxLength="50" Width="200px"></asp:TextBox></td>
                        </tr>
                        <tr style="height:24px">
                            <td style="width:120px; text-align: right; padding-right:10px">
                                ชนิดของนม :</td>
            ...
            <td>
                ...
                <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle" OnRowDataBound="gvMain_RowDataBound" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ชนิดของนม" SortExpression="NAME">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkFood" runat="server" Text='<%# Bind("NAME") %>' OnClick="lnkFood_Click" CommandArgument='<%# Bind("LOID")  %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="ISSPECIFIC" HeaderText="ธรรมดา/เฉพาะโรค" SortExpression="ISSPECIFIC">
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
            <td>
                <table cellpadding="5">
                    <tr>
                        <td align="right" style="width: 150px; padding-right: 10px;">
                    ...
                    <tr>
                        <td style="width:150px; padding-right: 10px;" align="right"> รหัสชนิด :</td>
                        <td>
                            <asp:TextBox ID="txtCode" runat="server" CssClass="zTextbox-View" Width="150px" MaxLength="20" ReadOnly="True"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width:150px; padding-right: 10px;" align="right"> ชื่อชนิดของนม :</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="chkSpecial" runat="server" Text="นมเฉพาะโรค" /></td>
                    </tr>
                    <tr>
                        <td style="width:150px; padding-right: 10px;" align="right"></td>
                        <td>
