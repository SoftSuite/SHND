...
{
    /// <summary>
    /// Represents a transaction for ORDERMEDICALITEM table.
    /// [Created by 127.0.0.1 on March,12 2009]
    /// </summary>
    public class OrderMedicalItemDAL
    {

        public OrderMedicalItemDAL()
        {
        }

        #region Constant

        /// <summary>ORDERMEDICALITEM</summary>
        private const string tableName = "ORDERMEDICALITEM";
        ...
        public string INCREASEMEAL
        {
            get { return _INCREASEMEAL; }
            set { _INCREASEMEAL = value; }
        }
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into ORDERMEDICALITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to ORDERMEDICALITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from ORDERMEDICALITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of ORDERMEDICALITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for ORDERMEDICALITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, DISEASECATEGORY, ISHIGH, ISLOW, ISNON, LOID, QTY, REFLOID, REFTABLE, INCREASEMEAL, UNIT) ";
                sql += "VALUES (";
                ...
                sql += DB.SetString(_INCREASEMEAL) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for ORDERMEDICALITEM table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "INCREASEMEAL = " + DB.SetString(_INCREASEMEAL) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for ORDERMEDICALITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for ORDERMEDICALITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of ORDERMEDICALITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["INCREASEMEAL"])) _INCREASEMEAL = zRdr["INCREASEMEAL"].ToString();
        ...
        public bool DeleteDataByConditions(string cREFTABLE, double cREFLOID, string exceptDiseaseCategoryList, OracleTransaction trans)
        {
