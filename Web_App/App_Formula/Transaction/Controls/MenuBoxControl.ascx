<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MenuBoxControl.ascx.cs" Inherits="App_Formula_Transaction_Controls_MenuBoxControl" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="500">
            <tr>
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; width: 200px;
                    ...
                    <asp:DropDownList ID="cmbUnitSelect" runat="server" CssClass="zComboBox" Visible="false" Width="70px" CausesValidation="True"></asp:DropDownList>
                ...
                <td style="padding-right: 4px; padding-left: 4px; padding-bottom: 4px; width: 200px;
                    padding-top: 4px; background-color: #f8f8ff; text-align: right">
                    <asp:ListBox ID="lstAll" runat="server" CssClass="zTextbox" Height="80px" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="lstAll_SelectedIndexChanged"></asp:ListBox>
                    ...
                    <asp:TextBox ID="txtQty" runat="server" CssClass="zTextboxR" Width="30px" Text="0"></asp:TextBox>
                     <asp:Label ID="lblUnit" runat="server" Text="หน่วย :"></asp:Label>
                    <asp:DropDownList ID="cmbUnit" runat="server" CssClass="zComboBox" Width="70px" CausesValidation="True"></asp:DropDownList>
