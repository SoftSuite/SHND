<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreWelfareRightQty.aspx.cs" Inherits="PreReport_PreWelfareRightQty" Title="SHND : Report - Welfare Right Qty" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="headtext">
                รายงานสรุปจำนวนผู้มีสิทธิ์รับบริการอาหารสวัสดิการ
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table  border="0" cellpadding="0" cellspacing="0" style="border-right: thin solid; border-top: thin solid; border-left: thin solid; border-bottom: thin solid; width: 600px;">
                <tr>
                ...
                <tr style="height:23px">
                    <td style="width:130px; padding-right:10px" align="right">
                        หน่วยงาน :</td>
                    <td colspan="3"  style="height: 23px"><asp:DropDownList ID="cmbDivision" runat="server" CssClass="zComboBox" Width="250px">
                        </asp:DropDownList>
                        </td>
                </tr> 
                <tr style="height:24px">
                    <td style="width:130px; padding-right:10px" align="right">
                        ผู้รับบริการ :</td>
                    <td colspan="3"  style="height: 23px"><asp:DropDownList ID="cmbReqDivision" runat="server" CssClass="zComboBox" Width="250px">
                        </asp:DropDownList>
                        </td>
                </tr> 
                 <tr style="height:24px">
