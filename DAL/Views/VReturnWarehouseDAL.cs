...
{
    /// <summary>
    /// Represents a transaction for V_RETURNWAREHOUSE view.
    /// [Created by 127.0.0.1 on March,4 2009]
    /// </summary>
    public class VReturnWarehouseDAL
    {

        public VReturnWarehouseDAL()
        {
        }

        #region Constant

        /// <summary>V_RETURNWAREHOUSE</summary>
        private const string viewName = "V_RETURNWAREHOUSE";
        ...
        /// <summary>
        /// Gets the select statement for V_RETURNWAREHOUSE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_RETURNWAREHOUSE by specified condition is retrieved successfully.
        /// </summary>
        ...
        #endregion
        public DataTable GetDataListByCondition(string cCODE, string cCODET, DateTime cDATE, DateTime cDATET, string cDOCTYPE, string cSTATUS, string cSTATUST,string   cWAREHOUSE, string orderBy, OracleTransaction trans)
        {
            //build where clause
            string whStr = "";
            ...
            if (cWAREHOUSE.Trim() != "0") whStr += (whStr.Trim() == "" ? "" : " AND ") + " UPPER(WAREHOUSE)  >=   " + DB.SetString(cWAREHOUSE) + " ";
