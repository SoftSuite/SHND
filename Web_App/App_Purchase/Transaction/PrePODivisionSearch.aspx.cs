...
/// Remark: -
/// Description:
///    หน้ากาารทำงานข้อมูล PrePODivision Search 
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
public partial class App_Purchase_Transaction_PrePODivisionSearch : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(Constant.HomeFolder + "App_Purchase/Transaction/PrePODivision.aspx");
    }

    protected void linkCode_Click(object sender, EventArgs e)
    {
        Response.Redirect(Constant.HomeFolder + "App_Purchase/Transaction/PrePODivision.aspx?loid=" + ((LinkButton)sender).CommandArgument);
    }
    ...
    private void doGetList()
    {
        ...
        pData.DIVISION = Appz.LoggedOnUser.DIVISION;
