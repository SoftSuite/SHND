...
/// </summary>
/// 
public partial class Search_WardPopup : System.Web.UI.UserControl
{
    ...
    private ArrayList GetSelectedData()
    {
        ...
        for (int i = 0; i < gvMain.Rows.Count; i++)
        {
            if (i > -1 && gvMain.Rows[i].Cells[0].FindControl("chkSelect") != null)
            {
                ...
                {
                    VWardResponseData VWardList = new VWardResponseData();
                    VWardList.WARD = Convert.ToDouble("0" + gRow.Cells[0].Text);
                    VWardList.WARDNAME = gRow.Cells[3].Text;
                    VWardList.ACTIVE = "1";
                    VWardList.ISDEFAULT = "0";
                    VWardList.PRIORITY = 0;
                    arrChk.Add(VWardList);
                }
            }
        }
        return arrChk;
    ...
    private void doGetList()
    {
      ...
      //  imbReset.Visible = (this.cmbSearchMaterialClass.SelectedIndex != 0 && this.cmbSearchMaterialClass.Enabled) || (txtSearchName.Text.Trim() != "");
        ...
        gvMain.DataSource = fFlow.GetWardList(this.txtExistMaterialMasterList.Text, orderStr);
        gvMain.DataBind();
        pcBot.Update();
        pcTop.Update();
    }
