...
{
    /// <summary>
    /// Represents a transaction for V_ORDERWELFAREITEM view.
    /// [Created by 127.0.0.1 on January,14 2009]
    /// </summary>
    public class VOrderWelfareItemDAL
    {

        public VOrderWelfareItemDAL()
        {
        }

        #region Constant

        /// <summary>V_ORDERWELFAREITEM</summary>
        private const string viewName = "V_ORDERWELFAREITEM";
        ...
        public DataTable GetDataListByOrderWelfare(double cORDERWELFARE, string orderBy, OracleTransaction trans)
        {
            return GetDataList("ORDERWELFARE = " + DB.SetDouble(cORDERWELFARE) + " ", orderBy, trans);
        }
        ...
        /// <summary>
        /// Gets the select statement for V_ORDERWELFAREITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_ORDERWELFAREITEM by specified condition is retrieved successfully.
        /// </summary>
