        ...
        <tr>
            ...
            <legend style="font-weight:bold">
             ...
             <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td style="width:120px; text-align: right; padding-right:10px">ชื่อหน่วยงาน</td>
                ...
                <uc2:PageControl ID="pcTop" runat="server" OnPageChange="PageChange"  />
                   <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle" OnRowDataBound="gvMain_RowDataBound" OnSorting="gvMain_Sorting" AllowPaging="True" PageSize="20" style="width:100%;">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ชื่อหน่วยงาน" SortExpression="NAME">
                        ...
                        <asp:BoundField  DataField="MAINDIVISIONNAME" HeaderText="หน่วยงานหลัก" SortExpression="MAINDIVISIONNAME">
                            <HeaderStyle HorizontalAlign="Center" Width="250px" />
                            <ItemStyle HorizontalAlign="Left" Width="250px" />
                          </asp:BoundField>
                          <asp:BoundField DataField="DIACTIVE" HeaderText="การใช้งาน" SortExpression="DIACTIVE">
            ...
            <td style="height: 198px">
                <table cellpadding="5">
                    <tr>
                     ...
                     <tr>
                        <td style="width:169px" align="right"> รหัสหน่วยงาน  </td>
                    ...
                    <tr>
                        <td style="width:169px; height: 32px;" align="right"> ชื่อหน่วยงาน </td>
                    ...
                    <tr>
                        <td style="width:169px" align="right"> หน่วยงานหลัก </td>
                        <td style="width: 614px">
                ...
                <tr><td><asp:CheckBox ID="chkNutrient" runat="server" Text="เป็นหน่วยงานของโภชนาการ"  /></td></tr>
                <tr><td><asp:CheckBox ID="chkFormula" runat="server" Text="สามารถกำหนดสูตรอาหารได้" /></td></tr>
                <tr><td><asp:CheckBox ID="chkPlan" runat="server" Text="สามารถทำแผนประมาณการได้" /></td></tr>
                <tr><td><asp:CheckBox ID="chkIsonlinerequest" runat="server" Text="สามารถเบิกวัสดุออนไลน์ได้" /></td></tr>
                <tr><td><asp:CheckBox ID="chkIsstockout" runat="server" Text="สามารถจ่ายวัสดุได้" /></td></tr>
                <tr><td><asp:CheckBox ID="chkIsparty" runat="server" Text="สามารถสั่งอาหารจัดเลี้ยงได้" /></td></tr>
                <tr><td><asp:CheckBox ID="chkIsdirector" runat="server" Text="สามารถอนุมัติอาหารจัดเลี้ยงได้" /></td></tr>
                <tr><td><asp:CheckBox ID="chkIswelfare" runat="server" Text="สามารถสั่งอาหารสวัสดิการได้" /></td></tr>
                </table>
