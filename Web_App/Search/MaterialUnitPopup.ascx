<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MaterialUnitPopup.ascx.cs" Inherits="Search_MaterialUnitPopup" %>
            ...
            <td>
                ...
                <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle" AllowPaging="True" PageSize="20" OnRowDataBound="gvMain_RowDataBound" OnSorting="gvMain_Sorting">
                    <Columns>
                        ...
                        <asp:BoundField DataField="COST" HeaderText="ราคา (บาท)" SortExpression="COST" HtmlEncode="false" DataFormatString="{0:#,##0.00}">
