...
/// <summary>
/// PreRequisitionMaterialList Class
/// Version 1.0
/// =========================================================================
/// Create by: Pom
...
/// Remark: -
/// Description:
///    หน้าการทำรายงาน RequisitionMaterialList
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
public partial class PreReport_PreRequisitionMaterialList : System.Web.UI.Page
{
    ...
    {
        base.OnInit(e);
        Appz.BuildCombo(cmbDivision, "DIVISION", "NAME", "LOID", "ISONLINEREQUEST='Y' AND ACTIVE='1'", "NAME", "ทั้งหมด", "0", false);
    ...
    protected void tbPrintClick(object sender, EventArgs e)
    {
        if (ValidateData() == true)
        {
            ...
            string script = OpenReportScript(Constant.Reports.RequisitionMaterialList, "paramfield1=division&paramvalue1=" + division +
