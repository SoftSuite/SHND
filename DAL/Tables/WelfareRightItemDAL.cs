...
{
    /// <summary>
    /// Represents a transaction for WELFARERIGHTITEM table.
    /// [Created by 127.0.0.1 on August,11 2009]
    /// </summary>
    public class WelfareRightItemDAL
    {

        public WelfareRightItemDAL()
        {
        }

        #region Constant

        /// <summary>WELFARERIGHTITEM</summary>
        private const string tableName = "WELFARERIGHTITEM";
        ...
        public bool GetDataByUniqueKey(double cWELFARERIGHT, double cDIVISION, OracleTransaction trans)
        {
            return doGetdata("WELFARERIGHT = " + DB.SetDouble(cWELFARERIGHT) + " AND DIVISION = " + DB.SetDouble(cDIVISION) + "  ", trans);
        }

        /// <summary>
        /// Returns an indication whether the current data is inserted into WELFARERIGHTITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to WELFARERIGHTITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from WELFARERIGHTITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of WELFARERIGHTITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for WELFARERIGHTITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, DIVISION, ISOVER, LOID, QTY, WELFARERIGHT) ";
                sql += "VALUES (";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDouble(_DIVISION) + ", ";
                sql += DB.SetString(_ISOVER) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetDouble(_QTY) + ", ";
                sql += DB.SetDouble(_WELFARERIGHT) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for WELFARERIGHTITEM table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "ISOVER = " + DB.SetString(_ISOVER) + ", ";
                sql += "QTY = " + DB.SetDouble(_QTY) + ", ";
                sql += "UPDATEBY = " + DB.SetString(_UPDATEBY) + ", ";
                sql += "UPDATEON = " + DB.SetDateTime(_UPDATEON) + ", ";
                sql += "WELFARERIGHT = " + DB.SetDouble(_WELFARERIGHT) + " ";
                return sql;
            }
        }

        /// <summary>
        /// Gets the delete statement for WELFARERIGHTITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for WELFARERIGHTITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of WELFARERIGHTITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["ISOVER"])) _ISOVER = zRdr["ISOVER"].ToString();
                        ...
                        if (!Convert.IsDBNull(zRdr["WELFARERIGHT"])) _WELFARERIGHT = Convert.ToDouble(zRdr["WELFARERIGHT"]);
                    }
                    else
                    {
                        ret = false;
