...
public partial class PreReport_PreMaterialCM : System.Web.UI.Page
{
    private void SetReportScript()
    {
        if (cmbMeal.SelectedValue == "00")
        {
            ...
            this.tbPrint.ClientClick = "if (document.getElementById('" + this.cmbMaterial.ClientID + "').value == '0') " +
                ...
                "else { " + Appz.OpenReportScript(Constant.Reports.MaterialCM, script, true) + "} ";
    ...
    {
        base.OnInit(e);
        Appz.BuildCombo(this.cmbMaterial, "V_MATERIALMASTER", "MATERIALNAME", "LOID", " MASTERTYPE = 'MD' AND ACTIVE='1' ", "MATERIALNAME", "เลือก", "0", true);
        SetReportScript();
    }
