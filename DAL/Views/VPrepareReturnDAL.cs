...
{
    /// <summary>
    /// Represents a transaction for V_PREPARE_RETURN_SEARCH view.
    /// [Created by 127.0.0.1 on May,11 2009]
    /// </summary>
    public class VPrepareReturnDAL
    {

        public VPrepareReturnDAL()
        {
        }

        #region Constant

        /// <summary>V_PREPARE_RETURN_SEARCH</summary>
        private const string viewName = "V_PREPARE_RETURN_SEARCH";
        ...
        /// <summary>
        /// Gets the select statement for V_PREPARE_RETURN_SEARCH table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_PREPARE_RETURN_SEARCH by specified condition is retrieved successfully.
        /// </summary>
