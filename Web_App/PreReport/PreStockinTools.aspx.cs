...
public partial class PreReport_PreStockinTools : System.Web.UI.Page
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        Appz.BuildCombo(this.cmbType, "DOCTYPE", "DOCNAME", "LOID", " ", "DOCNAME", "ทั้งหมด", "0", true);
        Appz.BuildCombo(this.cmbClass, "MATERIALCLASS", "NAME", "LOID", " MASTERTYPE = 'TL' ", "NAME", "ทั้งหมด", "0", true);
