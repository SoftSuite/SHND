...
/// Remark: -
/// Description:
///    หน้าการทำรายงาน StockOutMaterialList
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
public partial class PreReport_PreStockOutMaterialList : System.Web.UI.Page
{
    ...
    protected void tbPrintClick(object sender, EventArgs e)
    {
        if (ValidateData() == true)
        {
            ...
            string script = OpenReportScript(Constant.Reports.StockOutMaterialList, "paramfield1=division&paramvalue1=" + division +
