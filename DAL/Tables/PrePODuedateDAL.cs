...
{
    /// <summary>
    /// Represents a transaction for PREPODUEDATE table.
    /// [Created by 127.0.0.1 on Febuary,23 2009]
    /// </summary>
    public class PrePODuedateDAL
    {

        public PrePODuedateDAL()
        {
        }

        #region Constant

        /// <summary>PREPODUEDATE</summary>
        private const string tableName = "PREPODUEDATE";
        ...
        public bool InsertDuedate(double PrePOItem, string userID, OracleTransaction trans)
        {
            bool ret = true;
            try
            {
                DB.ExecuteNonQuery("CALL PKE_PURCHASE.SP_PREPODUEDATE(" + PrePOItem.ToString() + ", '" + userID + "')", trans);
            }
            catch (Exception ex)
            {
                ret = false;
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into PREPODUEDATE table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to PREPODUEDATE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from PREPODUEDATE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPODUEDATE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for PREPODUEDATE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, DUEDATE, DUEQTY, LOID, PREPOITEM) ";
                sql += "VALUES (";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDateTime(_DUEDATE) + ", ";
                sql += DB.SetDouble(_DUEQTY) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetDouble(_PREPOITEM) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for PREPODUEDATE table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "DUEQTY = " + DB.SetDouble(_DUEQTY) + ", ";
                sql += "PREPOITEM = " + DB.SetDouble(_PREPOITEM) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for PREPODUEDATE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for PREPODUEDATE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPODUEDATE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["DUEQTY"])) _DUEQTY = Math.Round(Convert.ToDouble(zRdr["DUEQTY"]),6);
