<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderSetControl.ascx.cs" Inherits="App_Prepare_Transaction_RegisterOrderPatient_OrderSetControl" %>
    ...
    <tr>
        <td>
            ...
            <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle1" CellPadding="0" OnRowDataBound="gvMain_RowDataBound" Width="100%">
                <Columns>
                    <asp:BoundField DataField="ORDERMEDICALSET" HeaderText="ORDERMEDICALSET">
                            ...
                            <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                ...
                                <tr style="height:20px">
                                    ...
                                    <td align="left" colspan="11">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class='<%# Eval("ISNPO").ToString() != "Y" ? "" : "zHidden" %>'>
                                            <tr style="height:20px">
                                            ...
                                            <tr style="height:20px" class='<%# Eval("CONTROL").ToString() == "" && Eval("LIMIT").ToString() == "" && Eval("INCREASE").ToString() =="" ? "zHidden" : "" %>' >
                                                <td colspan="2"><b>ควบคุม : </b><%# Eval("CONTROL") %></td>
                                                <td style="width:250px"><b>จำกัดปริมาณ : </b><%# Eval("LIMIT") %></td>
                                                <td><b>อาหารเสริม : </b><%# Eval("INCREASE") %></td>
                                            </tr>
                                            <tr style="height:20px" class='<%# Eval("ABSTAIN").ToString() == "" && Eval("NEED").ToString() == "" ? "zHidden" : "" %>' >
                                                <td colspan="2"><b>อาหารที่งด : </b><%# Eval("ABSTAIN") %></td>
                                                <td style="width:250px"><b>รับเฉพาะ : </b><%# Eval("NEED") %></td>
                                                <td></td>
                                            </tr>
                                            <tr style="height:20px">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class='<%# Eval("ISNPO").ToString() == "Y" ? "" : "zHidden" %>'>
                                            <tr style="height:20px">
                                                <td style="width:280px"><%# Eval("DESCRIPTIONS") %></td>
                                                <td style="width:250px"><b>สถานะ : </b><span style="color:Red"><%# Eval("STATUSNAME") %></span></td>
                                                <td><b>วัน-เวลาที่บันทึก : </b><%# Eval("MEDORDERDATE", "{0:dd/MM/yyyy HH:mm:ss}") %></td>
                                            </tr>
                                        </table> 
