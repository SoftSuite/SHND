...
{
    /// <summary>
    /// Represents a transaction for V_DIVISION view.
    /// [Created by 127.0.0.1 on January,13 2009]
    /// </summary>
    public class VDivisionDAL_
    {

        public VDivisionDAL_()
        {
        }

        #region Constant

        /// <summary>V_DIVISION</summary>
        private const string viewName = "V_DIVISION";
        ...
        /// <summary>
        /// Gets the select statement for V_DIVISION table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_DIVISION by specified condition is retrieved successfully.
        /// </summary>
