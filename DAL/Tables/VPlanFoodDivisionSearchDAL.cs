...
{
    /// <summary>
    /// Represents a transaction for V_PLAN_FOOD_DIVISION_SEARCH view.
    /// [Created by 127.0.0.1 on Febuary,11 2009]
    /// </summary>
    public class VPlanFoodDivisionSearchDAL
    {

        public VPlanFoodDivisionSearchDAL()
        {
        }

        #region Constant

        /// <summary>V_PLAN_FOOD_DIVISION_SEARCH</summary>
        private const string viewName = "V_PLAN_FOOD_DIVISION_SEARCH";
        ...
        /// <summary>
        /// Gets the select statement for V_PLAN_FOOD_DIVISION_SEARCH table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_PLAN_FOOD_DIVISION_SEARCH by specified condition is retrieved successfully.
        /// </summary>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["PHASEYEAR"])) _PHASEYEAR = zRdr["PHASEYEAR"].ToString();
        ...
        public DataTable GetDataListByConditions(double cDIVISION, string cNAME, double cPHASE, double cBUDGETYEAR, string cQTCODE, string cREFPRSAP, string cSTATUSRANKFROM, string cSTATUSRANKTO, string orderBy, OracleTransaction trans)
        {
            string whText = "";
            ...
            if (cPHASE != 0) whText += (whText == "" ? "" : "AND ") + "PHASE = " + DB.SetDouble(cPHASE) + " ";
