...
{
    /// <summary>
    /// Represents a transaction for PREPARERETURNITEM table.
    /// [Created by 10.10.10.10 on May,12 2009]
    /// </summary>
    public class PrepareReturnItemDAL
    {

        public PrepareReturnItemDAL()
        {
        }

        #region Constant

        /// <summary>PREPARERETURNITEM</summary>
        private const string tableName = "PREPARERETURNITEM";
        ...
        public double PREPARERETURN
        {
            get { return _PREPARERETURN; }
            set { _PREPARERETURN = value; }
        }
        public double QTY
        {
            get { return _QTY; }
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into PREPARERETURNITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to PREPARERETURNITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from PREPARERETURNITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPARERETURNITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for PREPARERETURNITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, LOID, MATERIALMASTER, PREPARERETURN, QTY, STOCKOUTQTY, UNIT) ";
                sql += "VALUES (";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetDouble(_MATERIALMASTER) + ", ";
                sql += DB.SetDouble(_PREPARERETURN) + ", ";
                sql += DB.SetDouble(_QTY) + ", ";
                sql += DB.SetDouble(_STOCKOUTQTY) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for PREPARERETURNITEM table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "PREPARERETURN = " + DB.SetDouble(_PREPARERETURN) + ", ";
                sql += "QTY = " + DB.SetDouble(_QTY) + ", ";
                sql += "STOCKOUTQTY = " + DB.SetDouble(_STOCKOUTQTY) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for PREPARERETURNITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for PREPARERETURNITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPARERETURNITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["PREPARERETURN"])) _PREPARERETURN = Convert.ToDouble(zRdr["PREPARERETURN"]);
                        if (!Convert.IsDBNull(zRdr["QTY"])) _QTY = Convert.ToDouble(zRdr["QTY"]);
                        if (!Convert.IsDBNull(zRdr["STOCKOUTQTY"])) _STOCKOUTQTY = Convert.ToDouble(zRdr["STOCKOUTQTY"]);
        ...
        public bool DeleteNotInLOIDList(string prloidlist, string preparereturn_loid, OracleTransaction trans)
        {
            string whrStr = "";
            if (prloidlist != "")
                whrStr = "PREPARERETURN = " + preparereturn_loid + " AND LOID NOT IN (" + prloidlist + ")";
            else
                whrStr = "PREPARERETURN = " + preparereturn_loid;
        ...
        public bool DeletePrepareReturnItem(string whText, OracleTransaction trans)
        {
            bool ret = true;
            _deletedRow = 0;
            if (whText.Trim() != "")
