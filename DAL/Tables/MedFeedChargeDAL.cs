...
{
    /// <summary>
    /// Represents a transaction for MEDFEEDCHARGE table.
    /// [Created by 127.0.0.1 on May,14 2009]
    /// </summary>
    public class MedFeedChargeDAL
    {

        public MedFeedChargeDAL()
        {
        }

        #region Constant

        /// <summary>MEDFEEDCHARGE</summary>
        private const string tableName = "MEDFEEDCHARGE";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into MEDFEEDCHARGE table successfully.
        /// </summary>
        ...
        public bool InsertCurrentData(string userID, OracleTransaction trans)
        {
            ...
            _CODE = DB.GetRunningCode(tableName, "CODE");
            _CREATEBY = userID;
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to MEDFEEDCHARGE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from MEDFEEDCHARGE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of MEDFEEDCHARGE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of MEDFEEDCHARGE by specified CODE key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for MEDFEEDCHARGE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CHARGEDATE, CODE, CREATEBY, CREATEON, LOID, STATUS, WARD) ";
                sql += "VALUES (";
                sql += DB.SetDateTime(_CHARGEDATE) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for MEDFEEDCHARGE table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "CHARGEDATE = " + DB.SetDateTime(_CHARGEDATE) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for MEDFEEDCHARGE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for MEDFEEDCHARGE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of MEDFEEDCHARGE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
