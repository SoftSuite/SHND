...
{
    /// <summary>
    /// Represents a transaction for STOCKCHECK table.
    /// [Created by 127.0.0.1 on Febuary,11 2009]
    /// </summary>
    public class StockCheckDAL
    {

        public StockCheckDAL()
        {
        }

        #region Constant

        /// <summary>STOCKCHECK</summary>
        private const string tableName = "STOCKCHECK";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into STOCKCHECK table successfully.
        /// </summary>
        ...
        public bool InsertCurrentData(string userID, OracleTransaction trans)
        {
            ...
            _BATCHNO = DB.GetRunningCode(tableName, "BATCHNO", trans);
            _CREATEBY = userID;
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to STOCKCHECK table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from STOCKCHECK table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of STOCKCHECK by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for STOCKCHECK table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(BATCHNO, CHECKDATE, CREATEBY, CREATEON, LOID, MATERIALCLASS, REMARKS, STATUS, WAREHOUSE) ";
                sql += "VALUES (";
                sql += DB.SetString(_BATCHNO) + ", ";
                sql += DB.SetDateTime(_CHECKDATE) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for STOCKCHECK table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "BATCHNO = " + DB.SetString(_BATCHNO) + ", ";
                sql += "CHECKDATE = " + DB.SetDateTime(_CHECKDATE) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for STOCKCHECK table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for STOCKCHECK table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of STOCKCHECK by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["CHECKDATE"])) _CHECKDATE = Convert.ToDateTime(zRdr["CHECKDATE"]);
        ...
        public string CheckDelete(double cLOID, OracleTransaction trans)
        {
            return DB.ExecuteScalar(sql_status+ "WHERE LOID = "+ cLOID, trans).ToString();
        }

        public string CheckStatus(double cLOID, OracleTransaction trans)
        {
            return DB.ExecuteScalar(sql_status + "WHERE LOID = " + cLOID, trans).ToString();
        }
        ...
        public bool CutStock(double stockCheck, OracleTransaction trans)
        {
            bool ret = true;
            try
            {
                DB.ExecuteNonQuery("CALL PKE_STOCK.SP_CUTSTOCKCHECK(" + stockCheck.ToString() + ")", trans);
            }
            catch (Exception ex)
            {
                ret = false;
