<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PlanOrderToolsDivisionSearch.aspx.cs" Inherits="App_Plan_Transaction_PlanOrderToolsDivisionSearch" Title="SHND : Transaction - Tool Order Planning" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">
                ข้อมูลแผนประมาณการวัสดุอุปกรณ์</td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle" OnRowDataBound="gvMain_RowDataBound" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="BUDGETYEAR" HeaderText="ปีงบปะมาณ" SortExpression="BUDGETYEAR">
