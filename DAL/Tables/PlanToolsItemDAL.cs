...
{
    /// <summary>
    /// Represents a transaction for PLANTOOLSITEM table.
    /// [Created by 127.0.0.1 on Febuary,16 2009]
    /// </summary>
    public class PlanToolsItemDAL
    {

        public PlanToolsItemDAL()
        {
        }

        #region Constant

        /// <summary>PLANTOOLSITEM</summary>
        private const string tableName = "PLANTOOLSITEM";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into PLANTOOLSITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to PLANTOOLSITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from PLANTOOLSITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of PLANTOOLSITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for PLANTOOLSITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CONTRACTCODE, CREATEBY, CREATEON, ISVAT, LOID, MATERIALMASTER, PLANORDER, PLANQTY, PRICE, SPEC, SUPPLIER, UNIT) ";
                sql += "VALUES (";
                sql += DB.SetString(_CONTRACTCODE) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for PLANTOOLSITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the delete statement for PLANTOOLSITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for PLANTOOLSITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PLANTOOLSITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        public bool DeleteDataByConditions(double cPLANORDER, string exceptMaterialMaster, OracleTransaction trans)
        {
            return doDelete("PLANORDER = " + DB.SetDouble(cPLANORDER) + " " + (exceptMaterialMaster == "" ? "" : ("AND MATERIALMASTER NOT IN (" + exceptMaterialMaster + ")")), trans);
        }

        public bool GetDataByConditions(double cPLANORDER, double cMATERIALMASTER, OracleTransaction trans)
        {
            return doGetdata("PLANORDER = " + DB.SetDouble(cPLANORDER) + " AND MATERIALMASTER = " + DB.SetDouble(cMATERIALMASTER), trans);
        }
