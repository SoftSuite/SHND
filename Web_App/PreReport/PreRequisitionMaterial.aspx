<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreRequisitionMaterial.aspx.cs" Inherits="PreReport_PreRequisitionMaterial" Title="SHND : Pre Requisiton Material"  %>
...
<table width="810px" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="headtext">
                &nbsp;รายงานสรุปยอดวัสดุอาหารที่หน่วยงานเบิก
            </td>
        </tr>
    </table>
