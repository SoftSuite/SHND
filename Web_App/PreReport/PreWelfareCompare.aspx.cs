...
/// Remark: -
/// Description:
///    หน้าการทำรายการข้อมูล PreWelfareCompare
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
public partial class PreReport_PreWelfareCompare : System.Web.UI.Page
{
    ...
    private void SetCombo()
    {
        ...
        Appz.BuildCombo(cmbReqDivision, "DIVISION", "NAME", "LOID", "ISWELFARE = 'Y' AND ISSUBDIVISION = 'N'", "NAME", "ทั้งหมด", "0", false);
    }
    ...
    protected void tbPrintClick(object sender, EventArgs e)
    {
        ...
        if (rdDay.Checked)
        {
            ...
            else
            {
                ...
                string script = OpenReportScript(Constant.Reports.WelfareCompareDayReport, "paramfield1=division&paramvalue1=" + cmbDivision.SelectedItem.Value +
        ...
        else if (rdMonth.Checked)
        {
            ...
            else
            {
                ...
                string script = OpenReportScript(Constant.Reports.WelfareCompareMonthReport, "paramfield1=division&paramvalue1=" + cmbDivision.SelectedItem.Value +
               "&paramfield2=reqdivision&paramvalue2=" + cmbReqDivision.SelectedItem.Value +
        ...
        else if (rdYear.Checked)
        {
            ...
            {
                string script = OpenReportScript(Constant.Reports.WelfareCompareYearReport, "paramfield1=division&paramvalue1=" + cmbDivision.SelectedItem.Value +
               "&paramfield2=reqdivision&paramvalue2=" + cmbReqDivision.SelectedItem.Value +
