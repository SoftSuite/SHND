...
public partial class PreReport_PreMaterialUseQty : System.Web.UI.Page
{
    ...
    private void SetReportScript()
    {
        ...
        if (rbtType.SelectedValue == "dd")
        {
            ...
            "{ alert('" + string.Format(DataResources.MSGEI002, "วันที่") + "'); return false; } else { " + Appz.OpenReportScript(Constant.Reports.MaterialUseQtyDate, scriptD, true) + "} ";
        ...
        else if (rbtType.SelectedValue == "mm")
        {
            ...
            "{ alert('" + string.Format(DataResources.MSGEI001, "เดือนและปี") + "'); return false; } else { " + Appz.OpenReportScript(Constant.Reports.MaterialUseQtyMonth, scriptM, true) + "} ";
        ...
        else
        {
            ...
            "{ alert('" + string.Format(DataResources.MSGEI001, "ปี") + "'); return false; } else { " + Appz.OpenReportScript(Constant.Reports.MaterialUseQtyYear, scriptY, true) + "} ";
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        Appz.BuildCombo(this.cmbContainer, "V_MATERIALMASTER", "MATERIALNAME", "LOID", " MASTERTYPE IN ('FO','MD','MI') ", "MATERIALNAME", "ทั้งหมด", "0", true);
        SetUnit();
