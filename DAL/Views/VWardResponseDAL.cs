...
{
    /// <summary>
    /// Represents a transaction for V_WARDRESPONSE view.
    /// [Created by 127.0.0.1 on July,30 2009]
    /// </summary>
    public class VWardResponseDAL
    {

        public VWardResponseDAL()
        {
        }

        #region Constant

        /// <summary>V_WARDRESPONSE</summary>
        private const string viewName = "V_WARDRESPONSE";
        ...
        public DataTable GetDataListByOfficer(double cOFFICER, string orderBy, OracleTransaction trans)
        {
            return GetDataList("OFFICER = " + DB.SetDouble(cOFFICER), orderBy, trans);
        }
        ...
        /// <summary>
        /// Gets the select statement for V_WARDRESPONSE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_WARDRESPONSE by specified condition is retrieved successfully.
        /// </summary>
