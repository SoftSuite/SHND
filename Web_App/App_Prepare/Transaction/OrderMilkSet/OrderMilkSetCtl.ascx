<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderMilkSetCtl.ascx.cs" Inherits="App_Prepare_Transaction_OrderMilkSet_OrderMilkSetCtl" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td>
            ...
            <uc2:ToolBarItemCtl ID="tbPrintList" runat="server" ToobarTitle ="พิมพ์รายงานการสั่งนม" ToolbarImage="../../Images/icn_print.png" />
        </td>
    </tr>
    <tr>
        <td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="900px">
                    ...
                    <tr style="height: 24px">
                        <td style="padding-right: 10px; width: 110px; text-align: right">
                            เจ้าของนม :</td>
                        <td colspan="7">
                            <asp:DropDownList ID="cmbMyMilk" runat="server" CssClass="zComboBox" Width="200px">
                                    <asp:ListItem Value="">ทั้งหมด</asp:ListItem>
                                    <asp:ListItem Value="S">นมของศิริราช</asp:ListItem>
                                    <asp:ListItem Value="M">นมของผู้ปกครอง</asp:ListItem>
                            </asp:DropDownList></td>
                    </tr>
                    <tr style="height: 24px">
                        <td style="padding-right: 10px; width: 110px; text-align: right">
                        ...
                        <HeaderTemplate>
                            <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                <tr style="height:20px" class="t_headtext">
                                    ...
                                    <td style="width:60px; border-right:solid 1px" align="center">VN</td>  
                        ...
                        <ItemTemplate>
                            <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                <tr style="height:20px" class='<%# Eval("RANK").ToString() != "0" ? "t_alt_bg" : "zHidden" %>'>
                                    ...
                                    <td style="width:60px; border-right:solid 1px" align="center"><%# Eval("VN") %></td>  
                                ...
                                <tr style="height:1px">
                                    ...
                                    <td style="width:30px; border-right:solid 1px" align="center"></td> 
                                    <td style="width:30px; border-right:solid 1px" align="center"></td> 
                                    <td style="width:60px; border-right:solid 1px" align="center"></td> 
                                    <td style="width:60px; border-right:solid 1px" align="center"></td> 
                                    <td style="width:60px; border-right:solid 1px" align="center"></td>  
                                ...
                                <tr style="height:20px">
                                    ...
                                    <td align="left" colspan="11">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr style="height:20px">
                                                <td style="width:80px"><b>No : </b><%# Eval("ORDERNO") %></td>
                                                <td style="width:120px"><b>ชนิดนมที่สั่ง : </b><%# Eval("MILKNAME") %></td>
                                                <td style="width:80px"><b>พลังงาน : </b><%# Eval("ENERGY") %></td>
                                                <td style="width:200px"><b>จำนวนมื้อ : </b><%# Eval("MEALQTY") %></td>
                                            ...
                                            <tr style="height:20px">
                                                ...
                                                <td colspan="4" ><b></b><span style="color:Blue"><%# Eval("OWNER") %></span></td>
                                                <td></td>
                                            </tr>
                                        </table>
                                    </td> 
