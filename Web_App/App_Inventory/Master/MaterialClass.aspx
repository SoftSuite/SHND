        ...
        <tr>
            ...
            <legend style="font-weight:bold">
             ...
             <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td style="width:120px; text-align: right; padding-right:10px; height: 24px;">ชื่อหมวดวัสดุ :</td>
                ...
                <uc2:PageControl ID="pcTop" runat="server" OnPageChange="PageChange" />
                 <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle" OnRowDataBound="gvMain_RowDataBound" OnSorting="gvMain_Sorting" AllowPaging="True" PageSize="20" style="width:100%;">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ชื่อหมวดวัสดุ" SortExpression="NAME">
                            <ItemTemplate>
                        ...
                        <asp:BoundField  DataField="STOCKINTYPENAME" HeaderText="วิธีการนำเข้า" SortExpression="STOCKINTYPENAME">
                          </asp:BoundField>
            ...
            <td>
                <table cellpadding="5">
                    <tr>
                     ...
                     <tr>
                        <td style="width:130px; padding-right: 10px;" align="right"> รหัส  :</td>
                        <td style="width: 614px">
                            <asp:TextBox ID="txtCode" runat="server" CssClass="zTextbox-View" Width="100px" MaxLength="20" Readonly="true" ></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width:130px; padding-right: 10px;" align="right"> ชื่อหมวดวัสดุ :</td>
                    ...
                    <tr>
                        <td style="width:130px; padding-right: 10px;" align="right"> วิธีการนำเข้า :</td>
                        <td style="width: 614px">
                    ...
                    <tr>
                        <td style="width:130px; padding-right: 10px;" align="right"> ประเภทข้อมูลพื้นฐาน :</td>
                        <td style="width: 614px">
