...
{
    /// <summary>
    /// Represents a transaction for V_FORMULAMILK_NUTRIENT view.
    /// [Created by 127.0.0.1 on Febuary,2 2009]
    /// </summary>
    public class VFormulaMilkNutrientDAL
    {

        public VFormulaMilkNutrientDAL()
        {
        }

        #region Constant

        /// <summary>V_FORMULAMILK_NUTRIENT</summary>
        private const string viewName = "V_FORMULAMILK_NUTRIENT";
        ...
        /// <summary>
        /// Gets the select statement for V_FORMULAMILK_NUTRIENT table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_FORMULAMILK_NUTRIENT by specified condition is retrieved successfully.
        /// </summary>
        ...
        private string sql_selectField
        {
            get
            {
                string sql = "SELECT LOID,NUTRIENTNAME,QTY||' '||UNITNAME QTY FROM " + viewName + " ";
                return sql;
            }
        }
        #endregion
