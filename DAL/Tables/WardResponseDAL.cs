...
{
    /// <summary>
    /// Represents a transaction for WARDRESPONSE table.
    /// [Created by 127.0.0.1 on June,24 2009]
    /// </summary>
    public class WardResponseDAL
    {

        public WardResponseDAL()
        {
        }

        #region Constant

        /// <summary>WARDRESPONSE</summary>
        private const string tableName = "WARDRESPONSE";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into WARDRESPONSE table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to WARDRESPONSE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from WARDRESPONSE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of WARDRESPONSE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for WARDRESPONSE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ACTIVE, CREATEBY, CREATEON, LOID, OFFICER, PRIORITY, WARD, ISDEFAULT) ";
                sql += "VALUES (";
        ...
        /// <summary>
        /// Gets the update statement for WARDRESPONSE table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "ISDEFAULT = " + DB.SetString(_ISDEFAULT) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for WARDRESPONSE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for WARDRESPONSE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of WARDRESPONSE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        public bool InsertWardAssign(ArrayList cWARD, double cOFFICER, string UserID, OracleTransaction trans)
        {
            bool ret = true;
            try
            {
                doDelete(" OFFICER = " + DB.SetDouble(cOFFICER) + " ", trans);

                _OFFICER = cOFFICER;
                _CREATEBY = UserID;
                _CREATEON = DateTime.Now;

                for (int i = 0; i < cWARD.Count; ++i)
                {
                    VWardResponseData datWard = (VWardResponseData)cWARD[i];
                    _OnDB = false;
                    _LOID = DB.GetNextID(TableName, trans);
                    _WARD = datWard.WARD;
                    _ACTIVE = datWard.ACTIVE;
                    _PRIORITY = datWard.PRIORITY;
                    _ISDEFAULT = datWard.ISDEFAULT;
                    doInsert(trans);
