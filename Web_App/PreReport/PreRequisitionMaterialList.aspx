<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreRequisitionMaterialList.aspx.cs" Inherits="PreReport_PreRequisitionMaterialList" Title="SHND : Pre Requisition Material List" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <table width="810px" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="headtext">
                &nbsp;รายงานสรุปรายการวัสดุอาหารที่หน่วยงานเบิก
            </td>
        </tr>
    </table>
