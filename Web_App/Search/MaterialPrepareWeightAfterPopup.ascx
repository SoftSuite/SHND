<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MaterialPrepareWeightAfterPopup.ascx.cs" Inherits="Search_MaterialPrepareWeightAfterPopup" %>
...
<asp:Panel ID="pnlMaterialMaster" runat="server" CssClass="modalPopupSearch" style="display:none" Width="800px">
    ...
    <asp:GridView ID="gvMain" runat="server"  AutoGenerateColumns="False" CssClass="t_tablestyle"  AllowPaging="True" PageSize="20" OnRowDataBound="gvMain_RowDataBound" Width="98%">
        <Columns>
