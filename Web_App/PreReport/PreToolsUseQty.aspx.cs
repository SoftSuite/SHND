...
public partial class PreReport_PreToolsUseQty : System.Web.UI.Page
{
    ...
    private void SetReportScript()
    {
        ...
        if (rbtType.SelectedValue == "dd")
        {
            ...
            "{ alert('" + string.Format(DataResources.MSGEI002, "วันที่") + "'); return false; } else { " + Appz.OpenReportScript(Constant.Reports.ToolsUseQtyDate, scriptD, true) + "} ";
        }
        else if (rbtType.SelectedValue == "mm")
        {
            ...
            "{ alert('" + string.Format(DataResources.MSGEI001, "เดือนและปี") + "'); return false; } else { " + Appz.OpenReportScript(Constant.Reports.ToolsUseQtyMonth, scriptM, true) + "} ";
        ...
        else
        {
            ...
            "{ alert('" + string.Format(DataResources.MSGEI001, "ปี") + "'); return false; } else { " + Appz.OpenReportScript(Constant.Reports.ToolsUseQtyYear, scriptY, true) + "} ";
