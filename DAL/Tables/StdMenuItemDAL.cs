...
{
    /// <summary>
    /// Represents a transaction for STDMENUITEM table.
    /// [Created by 127.0.0.1 on January,15 2009]
    /// </summary>
    public class StdMenuItemDAL
    {

        public StdMenuItemDAL()
        {
        }

        #region Constant

        /// <summary>STDMENUITEM</summary>
        private const string tableName = "STDMENUITEM";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into STDMENUITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to STDMENUITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from STDMENUITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of STDMENUITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for STDMENUITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, FORMULASET, GROUPTYPE, LOID, MATERIALMASTER, MEAL, QTY, STDMENUDATE, UNIT) ";
                sql += "VALUES (";
        ...
        /// <summary>
        /// Gets the update statement for STDMENUITEM table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "FORMULASET = " + (_FORMULASET == 0 ? "NULL" : DB.SetDouble(_FORMULASET)) + ", ";
                ...
                sql += "STDMENUDATE = " + DB.SetDouble(_STDMENUDATE) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for STDMENUITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for STDMENUITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of STDMENUITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["STDMENUDATE"])) _STDMENUDATE = Convert.ToDouble(zRdr["STDMENUDATE"]);
        ...
        public bool DeleteDataByConditions(double cSTDMENU, string cMEAL, double cMENUDATE, OracleTransaction trans)
        {
            return doDelete("MEAL = " + DB.SetString(cMEAL) + " AND STDMENUDATE IN (SELECT LOID FROM STDMENUDATE WHERE STDMENU = " + DB.SetDouble(cSTDMENU) + " AND MENUDATE = " + DB.SetDouble(cMENUDATE) + ") ", trans);
        }

        public bool DeleteDataByStdMenu(double cSTDMENU, OracleTransaction trans)
        {
            return doDelete("STDMENUDATE IN (SELECT LOID FROM STDMENUDATE WHERE STDMENU = " + DB.SetDouble(cSTDMENU) + ") ", trans);
        }
