        ...
        <tr>
            ...
            <legend style="font-weight:bold">
             ...
             <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td style="width:120px; text-align: right; padding-right:10px">ชื่อสารอาหาร :</td>
                ...
                <uc2:PageControl ID="pcTop" runat="server" OnPageChange="PageChange"  />
                   <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle"   OnRowDataBound="gvMain_RowDataBound" OnSorting="gvMain_Sorting"   AllowPaging="True" PageSize="20" style="width:100%;">
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="ชื่อสารอาหาร" SortExpression="NAME">
                            <ItemTemplate>                      
            ...
            <td style="height: 198px">
                <table cellpadding="5">
                    <tr>
                     ...
                     <tr>
                        <td style="width:120px; padding-right: 10px;" align="right"> รหัส/ชื่อย่อ  :</td>
                        <td style="width: 614px">
                            <asp:TextBox ID="txtCode" runat="server" CssClass="zTextbox" Width="100px" MaxLength="20"  ></asp:TextBox>
                            <span style="color:red">*</span></td>
                    </tr>
                    <tr>
                        <td style="width:120px; padding-right: 10px;" align="right"> ชื่อสารอาหาร :</td>
                    ...
                    <tr>
                        <td style="width:120px; padding-right: 10px;" align="right"> หน่วยนับ :</td>
                        <td style="width: 614px">
