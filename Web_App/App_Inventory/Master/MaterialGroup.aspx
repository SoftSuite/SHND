        ...
        <tr>
            ...
            <legend style="font-weight:bold">
             ...
             <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td style="width:120px; text-align: right; padding-right:10px; height: 22px;">ชื่อหมวดวัสดุ</td>
                        <td><asp:DropDownList ID="cmbClass" runat="server" Width="205px">
                </asp:DropDownList>
                    </td>
                    </tr>
                    <tr>
                        <td style="width:120px; text-align: right; padding-right:10px">ชื่อประเภทวัสดุ</td>
                ...
                <uc2:PageControl ID="pcTop" runat="server" OnPageChange="PageChange" />
                   <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle" OnRowDataBound="gvMain_RowDataBound" OnSorting="gvMain_Sorting" AllowPaging="True" PageSize="20" style="width:100%;">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ชื่อประเภทวัสดุ" SortExpression="NAME">
                        ...
                        <asp:BoundField  DataField="MATERIALCLASSNAME" HeaderText="หมวดวัสดุ" SortExpression="MATERIALCLASSNAME">
                          </asp:BoundField>
            ...
            <td>
                <table cellpadding="5">
                    <tr>
                     ...
                     <tr>
                        <td style="width:150px" align="right"> รหัสประเภทวัสดุ  </td>
                        <td style="width: 614px">
                            <asp:TextBox ID="txtCode" runat="server" CssClass="zTextbox-View" Width="100px" MaxLength="20" Readonly ></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width:150px; height: 32px;" align="right"> ชื่อประเภทวัสดุ </td>
                    ...
                    <tr>
                        <td style="width:150px" align="right"> หมวดวัสดุ </td>
                        <td style="width: 614px">
