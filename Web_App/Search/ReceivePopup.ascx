            ...
            <td>
                <fieldset style="padding:15px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="700">
                        ...
                        <tr style="height:24px">
                            <td style="width:130px; padding-right:10px; text-align:right">วันที่กำหนดส่ง :</td>
                            <td>
            ...
            <td>
                ...
                <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle" AllowPaging="True" PageSize="20" OnRowDataBound="gvMain_RowDataBound" OnSorting="gvMain_Sorting">
                    <Columns>
                        ...
                        <asp:BoundField DataField="DUEQTY" HeaderText="จำนวนส่ง" SortExpression="DUEQTY" HtmlEncode="false" DataFormatString="{0:#,##0.00}">
                        ...
                        <asp:BoundField DataField="MATERIALCLASSNAME" HeaderText="หมวดวัสดุ" SortExpression="CLASSNAME">
