...
{
    /// <summary>
    /// Represents a transaction for RECEIVE table.
    /// [Created by 127.0.0.1 on March,13 2009]
    /// </summary>
    public class ReceiveDAL
    {
        ...
        private const string tableName = "RECEIVE";
        ...
        public bool GetDataByUniqueKey(double cPLANMATERIALCLASS, DateTime cRECEIVEDATE, OracleTransaction trans)
        {
            return doGetdata(" PLANMATERIALCLASS = " + DB.SetDouble(cPLANMATERIALCLASS) + " AND RECEIVEDATE = " + DB.SetDateTime(cRECEIVEDATE), trans);
        }

        /// <summary>
        /// Returns an indication whether the current data is inserted into RECEIVE table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to RECEIVE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from RECEIVE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of RECEIVE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for RECEIVE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, LOID, PLANMATERIALCLASS, RECEIVEDATE, REMARKS, STATUS) ";
                sql += "VALUES (";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetDouble(_PLANMATERIALCLASS) + ", ";
                sql += DB.SetDateTime(_RECEIVEDATE) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for RECEIVE table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "RECEIVEDATE = " + DB.SetDateTime(_RECEIVEDATE) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for RECEIVE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for RECEIVE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of RECEIVE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
