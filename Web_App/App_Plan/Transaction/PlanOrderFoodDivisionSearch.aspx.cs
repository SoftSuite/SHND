...
/// Remark: -
/// Description:
///    หน้าการทำรายการข้อมูล PlanOrderFoodDivisionSearch
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
/// </summary>
/// 
public partial class App_Plan_Transaction_PlanOrderFoodDivisionSearch : System.Web.UI.Page
{
    private void SetStatusCombo(DropDownList cmb)
    {
        cmb.Items.Clear();
        cmb.Items.Add(new ListItem("รวบรวมความต้องการ", "01"));
        cmb.Items.Add(new ListItem("ส่งให้ธุรการ", "02"));
    ...
    {
        Response.Redirect(Constant.HomeFolder + "App_Plan/Transaction/PlanOrderFoodDivision.aspx?loid=" + ((LinkButton)sender).CommandArgument);
    }
    ...
    private void doGetList()
    {
        ...
        imbReset.Visible = (txtSearchPlanName.Text.Trim() != "") || (Convert.ToDouble("0" + this.txtSearchPhase.Text) != 0) || (Convert.ToDouble("0" + this.txtSearchBudgetYear.Text) != 0)
            || (this.txtSearchQtCode.Text.Trim() != "") || (this.txtSearchRefPRSap.Text.Trim() != "") || (cmbSearchStatusFrom.SelectedIndex != 0) || (cmbSearchStatusTo.SelectedIndex != 1);

        string orderStr = "";
        if (txhSortField.Text.Trim() != "")
            orderStr = " " + txhSortField.Text + " " + txhSortDir.Text;

        gvMain.DataSource = fFlow.GetMasterList(Appz.LoggedOnUser.DIVISION, this.txtSearchPlanName.Text.Trim(), Convert.ToInt32("0" + this.txtSearchPhase.Text), Convert.ToInt32("0" + this.txtSearchBudgetYear.Text),
