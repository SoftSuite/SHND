...
public partial class PreReport_PrePatientQtyTypeFeed : System.Web.UI.Page
{
    private void SetReportScript()
    {
        ...
        string scriptD = "paramfield1=division&paramvalue1=" + Server.UrlEncode(txtDivisionName.Text) +
            ...
            "&paramfield4=typefeed&paramvalue4=' + document.getElementById('" + this.cmbFeedName.ClientID + "').value + '" +
            ...
            "&paramfield10=foodtype&paramvalue10=' + document.getElementById('" + this.cmbFoodType.ClientID + "').value + '";
        ...
        string scriptM = "paramfield1=division&paramvalue1=" + Server.UrlEncode(txtDivisionName.Text) +
            ...
            "&paramfield6=typefeed&paramvalue6=' + document.getElementById('" + this.cmbFeedName.ClientID + "').value + '" +
            ...
            "&paramfield12=foodtype&paramvalue12=' + document.getElementById('" + this.cmbFoodType.ClientID + "').value + '";
        ...
        if (rbtType.SelectedValue == "dd")
        {
            ...
            this.tbPrint.ClientClick = "if (document.getElementById('" + this.ctlDateFrom.CalendarClientID + "').value == '' || document.getElementById('" + this.ctlDateTo.CalendarClientID + "').value == '') " +
             "{ alert('" + string.Format(DataResources.MSGEI002, "วันที่") + "'); return false; } else { " + Appz.OpenReportScript(Constant.Reports.PatientQtyTypeFeedDate, scriptD, true) + "} ";
        ...
        else if (rbtType.SelectedValue == "mm")
        {
            ...
            "{ alert('" + string.Format(DataResources.MSGEI001, "เดือนและปี") + "'); return false; } else { " + Appz.OpenReportScript(Constant.Reports.PatientQtyTypeFeedMonth, scriptM, true) + "} ";
        ...
        else
        {
            ...
            "{ alert('" + string.Format(DataResources.MSGEI001, "ปี") + "'); return false; } else { " + Appz.OpenReportScript(Constant.Reports.PatientQtyTypeFeedYear, scriptY, true) + "} ";
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        Appz.BuildCombo(this.cmbFoodType, "FOODTYPE", "NAME", "LOID", "ISNURSE='Y' AND ACTIVE = '1'", "NAME", "ทั้งหมด", "0", false);
