...
/// <summary>
/// PreStockoutMaterial Page Class
/// Version 1.0
/// =========================================================================
/// Create by: Nang
...
/// Remark: -
/// Description:
///    หน้าการทำรายการข้อมูล PreStockoutMaterial
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
public partial class PreReport_PreStockoutMaterial : System.Web.UI.Page
{
    ...
    {
        base.OnInit(e);
        Appz.BuildCombo(cmbDivision, "DIVISION", "NAME", "LOID", "ISONLINEREQUEST = 'Y'", "NAME", "ทั้งหมด", "0", true);
        ...
        Appz.BuildCombo(cmbUnit, "V_MATERIALMASTER_UNIT", "UNITNAME", "UNIT", "ISSTOCKIN = 'Y'", "NAME", "ทั้งหมด", "0", true);
    ...
    protected void tbPrintClick(object sender, EventArgs e)
    {
        ...
        if (rdDay.Checked)
        {
            ...
            {
                lbStatusMain.Text = "กรุณาระบุช่วงวันที่";
            ...
            else
            {
                ...
                string script = OpenReportScript(Constant.Reports.StockOutMaterialDayReport, "paramfield1=class&paramvalue1=" + cmbMaterialClass.SelectedItem.Value +
               "&paramfield2=material&paramvalue2=" + cmbMaterialMaster.SelectedItem.Value +
               ...
               "&paramfield8=division&paramvalue8=" + cmbDivision.SelectedItem.Value, false);
        ...
        else if (rdMonth.Checked)
        {
            ...
            {
                lbStatusMain.Text = "กรุณาระบุช่วงเดือน";
                lbStatusMain.ForeColor = Constant.StatusColor.Error;
                CheckRadio();
                return;
            }
            ...
            {
                lbStatusMain.Text = "กรุณาระบุช่วงปี";
                lbStatusMain.ForeColor = Constant.StatusColor.Error;
                CheckRadio();
                return;
            }
            ...
            {
                lbStatusMain.Text = "กรุณาระบุช่วงเดือนและปี";
                lbStatusMain.ForeColor = Constant.StatusColor.Error;
                CheckRadio();
                return;
            }
            ...
            else
            {
                ...
                string script = OpenReportScript(Constant.Reports.StockOutMaterialMonthReport, "paramfield1=class&paramvalue1=" + cmbMaterialClass.SelectedItem.Value +
               "&paramfield2=material&paramvalue2=" + cmbMaterialMaster.SelectedItem.Value +
               "&paramfield3=v_unit&paramvalue3=" + cmbUnit.SelectedItem.Value +
        ...
        else if (rdYear.Checked)
        {
            ...
            {
                CheckRadio();
                string script = OpenReportScript(Constant.Reports.StockoutMaterialYearReport, "paramfield1=class&paramvalue1=" + cmbMaterialClass.SelectedItem.Value +
               "&paramfield2=material&paramvalue2=" + cmbMaterialMaster.SelectedItem.Value +
               "&paramfield3=v_unit&paramvalue3=" + cmbUnit.SelectedItem.Value +
               ...
               "&paramfield6=division&paramvalue6="+ cmbDivision.SelectedItem.Value, false);
                ScriptManager.RegisterStartupScript(Page, GetType(), "report", "<script language='javascript'>" + script + "</script>", false);
            }
        }
