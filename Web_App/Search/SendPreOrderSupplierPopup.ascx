<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SendPreOrderSupplierPopup.ascx.cs" Inherits="Search_SendPreOrderSupplierPopup" %>
...
<asp:Panel ID="pnlMaterialMaster" runat="server" CssClass="modalPopupSearch" style="display:none" >
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="headtext">รายการวัสดุอาหาร
            </td>
        </tr>
        <tr>
            <td><uc1:ToolBarItemCtl ID="tbBack" runat="server" ToobarTitle="กลับหน้ารายการ" ToolbarImage="../../Images/icn_back.png" OnClick="tbBackClick" />
                ...
                <asp:TextBox ID="txtSupplier" runat="server" Visible="False" Width="15px"></asp:TextBox>
