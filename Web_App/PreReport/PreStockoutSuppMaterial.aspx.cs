...
public partial class PreReport_PreStockoutSuppMaterial : System.Web.UI.Page
{
    ...
    {
        string scriptD = "paramfield1=supplier&paramvalue1=' + document.getElementById('" + this.cmbSupplier.ClientID + "').value + '" +
        ...
        string scriptM = "paramfield1=supplier&paramvalue1=' + document.getElementById('" + this.cmbSupplier.ClientID + "').value + '" +
        ...
        string scriptY = "paramfield1=supplier&paramvalue1=' + document.getElementById('" + this.cmbSupplier.ClientID + "').value + '" +
        ...
        if (rbtType.SelectedValue == "dd")
        {
            ...
            "else { " + Appz.OpenReportScript(Constant.Reports.StockOutSuppMaterialDate, scriptD, true) + "} ";
        ...
        else if (rbtType.SelectedValue == "mm")
        {
            ...
            "else if (document.getElementById('" + this.cmbMaterial.ClientID + "').value != '0' & document.getElementById('" + this.cmbUnit.ClientID + "').value == '0') " +
            "{ alert('" + string.Format(DataResources.MSGEI002, "หน่วย") + "'); return false; } " +
            "else { " + Appz.OpenReportScript(Constant.Reports.StockOutSuppMaterialMonth, scriptM, true) + "} ";
        ...
        else
        {
            ...
            "else if (document.getElementById('" + this.cmbMaterial.ClientID + "').value != '0' & document.getElementById('" + this.cmbUnit.ClientID + "').value == '0') " +
            "{ alert('" + string.Format(DataResources.MSGEI002, "หน่วย") + "'); return false; } " +
            "else { " + Appz.OpenReportScript(Constant.Reports.StockOutSuppMaterialYear, scriptY, true) + "} ";
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        Appz.BuildCombo(this.cmbSupplier, "SUPPLIER", "NAME", "LOID", " ", "NAME", "ทั้งหมด", "0", true);
