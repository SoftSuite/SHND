...
{
    /// <summary>
    /// Represents a transaction for RECEIVEITEM table.
    ...
    public class ReceiveItemDAL
    {
        ...
        /// <summary>RECEIVEITEM</summary>
        private const string tableName = "RECEIVEITEM";
        ...
        public bool GetDataByUniqueKey(double cReceive, double cMATERIALMASTER, double cUNIT, double cPREPODUEDATE, OracleTransaction trans)
        {
            return doGetdata("RECEIVE = " + DB.SetDouble(cReceive) + " AND MATERIALMASTER = " + DB.SetDouble(cMATERIALMASTER) + "  AND UNIT = " + DB.SetDouble(cUNIT) + "  AND PREPODUEDATE = " + DB.SetDouble(cPREPODUEDATE) + " ", trans);
        }

        /// <summary>
        /// Returns an indication whether the current data is inserted into RECEIVEITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to RECEIVEITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from RECEIVEITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of RECEIVEITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for RECEIVEITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, LOID, MATERIALMASTER, PREPODUEDATE, RECEIVE, RECEIVEQTY, REMARKS, UNIT) ";
                sql += "VALUES (";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetDouble(_MATERIALMASTER) + ", ";
                sql += DB.SetDouble(_PREPODUEDATE) + ", ";
                sql += DB.SetDouble(_RECEIVE) + ", ";
                sql += DB.SetDouble(_RECEIVEQTY) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for RECEIVEITEM table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "PREPODUEDATE = " + DB.SetDouble(_PREPODUEDATE) + ", ";
                sql += "RECEIVE = " + DB.SetDouble(_RECEIVE) + ", ";
                sql += "RECEIVEQTY = " + DB.SetDouble(_RECEIVEQTY) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for RECEIVEITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for RECEIVEITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of RECEIVEITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
