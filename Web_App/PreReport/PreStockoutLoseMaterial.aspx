<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreStockoutLoseMaterial.aspx.cs" Inherits="PreReport_PreStockoutLoseMaterial" Title="SHND : Report - Stockout Lost Material" %>
<%@ Register Src="../Templates/CalendarControl.ascx" TagName="CalendarControl" TagPrefix="uc2" %>
<%@ Register Src="../Templates/ToolBarItemCtl.ascx" TagName="ToolBarItemCtl" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">รายงานสรุปยอดวัสดุอาหารที่จำหน่ายออกเป็นของเสีย
            </td>
        </tr>
        <tr>
            <td>
