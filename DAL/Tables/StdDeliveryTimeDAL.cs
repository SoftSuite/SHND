...
{
    /// <summary>
    /// Represents a transaction for STDDELIVERYTIME table.
    /// [Created by 127.0.0.1 on July,29 2009]
    /// </summary>
    public class StdDeliveryTimeDAL
    {

        public StdDeliveryTimeDAL()
        {
        }

        #region Constant

        /// <summary>STDDELIVERYTIME</summary>
        private const string tableName = "STDDELIVERYTIME";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into STDDELIVERYTIME table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to STDDELIVERYTIME table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from STDDELIVERYTIME table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of STDDELIVERYTIME by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for STDDELIVERYTIME table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CUTOFFTIME, DELIVERYTIME, LOID, MEAL, TIME1, TIME10, TIME11, TIME12, TIME13, TIME14, TIME15, TIME16, TIME17, TIME18, TIME19, TIME2, TIME20, TIME21, TIME22, TIME23, TIME24, TIME3, TIME4, TIME5, TIME6, TIME7, TIME8, TIME9, USEFOR) ";
                sql += "VALUES (";
                sql += DB.SetString(_CUTOFFTIME) + ", ";
                sql += DB.SetString(_DELIVERYTIME) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for STDDELIVERYTIME table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "CUTOFFTIME = " + DB.SetString(_CUTOFFTIME) + ", ";
                sql += "DELIVERYTIME = " + DB.SetString(_DELIVERYTIME) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for STDDELIVERYTIME table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for STDDELIVERYTIME table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of STDDELIVERYTIME by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        public bool doGetdata(string whText, OracleTransaction trans)
        {
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    {
                        _OnDB = true;
                        if (!Convert.IsDBNull(zRdr["CUTOFFTIME"])) _CUTOFFTIME = zRdr["CUTOFFTIME"].ToString();
                        if (!Convert.IsDBNull(zRdr["DELIVERYTIME"])) _DELIVERYTIME = zRdr["DELIVERYTIME"].ToString();
        ...
        public string GetCutOffTime(string usefor,string time)
        {
            string sql = "SELECT * FROM STDDELIVERYTIME WHERE USEFOR = '" + usefor + "' AND TIME" + time + "='Y' ";

            DataTable dt = DB.ExecuteTable(sql);
            string cuttime = "";
            if (dt.Rows.Count > 0)
            {
                cuttime = dt.Rows[0]["CUTOFFTIME"].ToString();
