...
/// <summary>
/// PlanContractToolsSearch Page Class
/// Version 1.0
/// =========================================================================
/// Create by: Teang
...
/// Remark: -
/// Description:
///    หน้าการทำรายการข้อมูล PlanContractToolsSearch
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
/// </summary>
/// 
public partial class App_Plan_Transaction_PlanContractToolsSearch : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(Constant.HomeFolder + "App_Plan/Transaction/PlanContractTools.aspx?loid=" + ((LinkButton)sender).CommandArgument);
    }
