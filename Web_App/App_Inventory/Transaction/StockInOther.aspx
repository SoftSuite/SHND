                            ...
                            <td style="padding:5px; border-right: 1px solid; border-top: 1px solid; border-left: 1px solid; border-bottom: 1px solid; width:620px;" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" width="600">
                                    <tr style="height:24px">
                                        <td style="width:120px; text-align: right; padding-right:10px">เลขที่รับเข้าคลัง :&nbsp;</td>
                                        ...
                                        <td style="width:100px; text-align: right; padding-right:10px">วันที่รับ :</td>
                                        <td ><uc3:CalendarControl ID="ctlStockInDate" runat="server"  />
                                            &nbsp;<span style="color:red">*</span>
                                        </td> 
                                    </tr>
                                    <tr style="height:24px">
                                        <td style="width:120px; text-align: right; padding-right:10px;">คลังที่รับเข้า :&nbsp;</td>
             ...
             <td>
              <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"  Width="100%" DataSourceID="StockInOtherSource">
                        ...
                        <asp:BoundField DataField="UNITNAME" HeaderText="หน่วยนับ">
                            ...
                            <asp:TemplateField HeaderText="ยี่ห้อ" >
                                <ItemTemplate>
