...
{
    /// <summary>
    /// Represents a transaction for PREPODIVISIONITEM table.
    /// [Created by 127.0.0.1 on Febuary,25 2009]
    /// </summary>
    public class PrePODivisionItemDAL
    {

        public PrePODivisionItemDAL()
        {
        }

        #region Constant

        /// <summary>PREPODIVISIONITEM</summary>
        private const string tableName = "PREPODIVISIONITEM";
        ...
        {
            return doGetdata("PREPODIVISION = " + DB.SetDouble(cPrePO) + " AND MATERIALMASTER = " + DB.SetDouble(cMATERIALMASTER) + "  AND UNIT = " + DB.SetDouble(cUNIT) + " ", trans);
        }

        /// <summary>
        /// Returns an indication whether the current data is inserted into PREPODIVISIONITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to PREPODIVISIONITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from PREPODIVISIONITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPODIVISIONITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for PREPODIVISIONITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, ISVAT, LOID, MATERIALMASTER, MENUQTY, ORDERQTY, PLANREMAINQTY, PREPODIVISION, PRICE, REMARKS, UNIT, USEQTY) ";
                sql += "VALUES (";
                ...
                sql += DB.SetDouble(_PREPODIVISION) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for PREPODIVISIONITEM table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "PREPODIVISION = " + DB.SetDouble(_PREPODIVISION) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for PREPODIVISIONITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for PREPODIVISIONITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPODIVISIONITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        public double GetUseQty(double plan, double division, double materialmaster)
        {
            ...
            sql += "INNER JOIN PLANMATERIALCLASS PLC ON PLC.LOID=PD.PLANMATERIALCLASS WHERE PLC.PLANORDER = '" + plan + "' AND PD.DIVISION = '" + division + "' AND PDI.MATERIALMASTER = '" + materialmaster + "' ";
