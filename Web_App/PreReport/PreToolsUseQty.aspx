<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreToolsUseQty.aspx.cs" Inherits="PreReport_PreToolsUseQty" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">รายงานสรุปจำนวนการใช้วัสดุอุปกรณ์ งานบ้านงานครัว
            </td>
        </tr>
        <tr>
            <td>
