<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreStockinMaterial.aspx.cs" Inherits="PreReport_PreStockinMaterial" Title="SHND : Pre Stock In Material" %>
...
<table width="810px" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="headtext">
                &nbsp;รายงานสรุปยอดวัสดุอาหารที่รับเข้าคลัง
            </td>
        </tr>
    </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-right: thin solid; border-top: thin solid; border-left: thin solid; border-bottom: thin solid; width: 591px;">
                ...
                <tr style="height:23px">
                    <td style="width:130px; padding-right:10px" align="right">
                        ประเภทการรับเข้า :</td>
                    <td colspan="3"  style="height: 23px"><asp:DropDownList ID="cmbStockInType" runat="server" CssClass="zComboBox" Width="380px">
                        </asp:DropDownList>
                        </td>
                </tr> 
