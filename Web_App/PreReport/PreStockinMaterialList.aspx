<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreStockinMaterialList.aspx.cs" Inherits="PreReport_PreStockinMaterialList" Title="SHND : Pre Stock In Material List" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <table width="810px" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="headtext">
                &nbsp;รายงานสรุปรายการวัสดุอาหารที่รับเข้าคลัง
            </td>
        </tr>
    </table>
    ...
    <table width="450px" border="0" cellpadding="0" cellspacing="0" style="border-right: thin solid; border-top: thin solid; border-left: thin solid; border-bottom: thin solid">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="cmbStockinType" runat="server" CssClass="zComboBox" Width="282px"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td style="width:35px; height: 25px;"></td>
