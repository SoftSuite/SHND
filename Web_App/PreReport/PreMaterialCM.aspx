<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreMaterialCM.aspx.cs" Inherits="PreReport_PreMaterialCM" Title="SHND : Report - MaterialCM"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">รายงานสรุปจำนวนการเบิกอาหารทางการแพทย์
            </td>
        </tr>
        <tr>
            <td>
