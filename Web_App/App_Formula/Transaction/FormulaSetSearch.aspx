            ...
            <legend style="font-weight:bold">
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="1050px">
                    ...
                    <tr style="height:24px">
                        ...
                        <td colspan="4">
                            <asp:CheckBox ID="chkActive" runat="server" Checked="True" Text="แสดงเฉพาะสูตรที่ใช้งาน">
                            </asp:CheckBox>
</td>
                    </tr>
                    <tr style="height:24px">
            ...
            <td >
                ...
                <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle" OnRowDataBound="gvMain_RowDataBound" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton ID="imbDelete" runat="server" ImageUrl="~/Images/icn_delete.png" ToolTip="ลบข้อมูล" CommandArgument='<%# Bind("LOID") %>' OnClick="imbDelete_Click" Visible='<%# (Eval("STATUS").ToString() != "AP") && (Eval("DIVISION").ToString() == txtDivision.Text) %>'/>
                        ...
                        <asp:TemplateField HeaderText="ชื่อสูตรอาหาร" SortExpression="FORMULANAME">
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="SPECIALTYPE" HeaderText="ธรรมดา/เฉพาะโรค" SortExpression="SPECIALTYPE">
                            <HeaderStyle Width="120px" />
                            <ItemStyle Width="120px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ENERGY" HeaderText="พลังงาน (kcal)" SortExpression="ENERGY" HtmlEncode="False" DataFormatString="{0:#,##0}">
                        ...
                        <asp:BoundField DataField="WEIGHT" HeaderText="น้ำหนัก (g)" SortExpression="WEIGHT" HtmlEncode="False" DataFormatString="{0:#,##0.00}">
                            <HeaderStyle Width="70px" />
                            <ItemStyle Width="70px" HorizontalAlign="Right" />
                        </asp:BoundField>
