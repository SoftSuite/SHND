...
public partial class PreReport_PrePrepareSet : System.Web.UI.Page
{
    ...
    {
        Appz.BuildCombo(this.cmbFoodType, "FOODTYPE", "NAME", "LOID", " ACTIVE='1' AND DIVISION= " + cmbDivision.SelectedValue + " ", "NAME", "ทั้งหมด", "0", true);
        Appz.BuildCombo(this.cmbMenu, "MENU", "NAME", "LOID", " STATUS='AP' AND DIVISION= " + cmbDivision.SelectedValue + " ", "NAME", "ทั้งหมด", "0", true);
    }
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        Appz.BuildCombo(this.cmbDivision, "DIVISION", "NAME", "LOID", " ISFORMULA='Y' AND ACTIVE='1' ", "NAME", "ทั้งหมด", "0", true);
        Appz.BuildCombo(this.cmbFoodCategory, "FOODCATEGORY", "NAME", "LOID", " ACTIVE='1' ", "NAME", "ทั้งหมด", "0", true);
        Appz.BuildCombo(this.cmbMaterialGroup, "MATERIALGROUP", "NAME", "LOID", " ACTIVE='1' ", "NAME", "ทั้งหมด", "0", true);
        Appz.BuildCombo(this.cmbFoodType, "FOODTYPE", "NAME", "LOID", " ACTIVE='1' AND DIVISION= " + cmbDivision.SelectedValue + " ", "NAME", "ทั้งหมด", "0", true);
        Appz.BuildCombo(this.cmbMenu, "MENU", "NAME", "LOID", " STATUS='AP' AND DIVISION= " + cmbDivision.SelectedValue + " ", "NAME", "ทั้งหมด", "0", true);
