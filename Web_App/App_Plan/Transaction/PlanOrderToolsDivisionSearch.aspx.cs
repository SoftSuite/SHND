...
/// <summary>
/// PlanOrderToolsDivisionSearch Page Class
/// Version 1.0
/// =========================================================================
/// Create by: Teang
...
/// Remark: -
/// Description:
///    หน้าการทำรายการข้อมูล PlanOrderToolsDivisionSearch
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
/// </summary>
/// 
public partial class App_Plan_Transaction_PlanOrderToolsDivisionSearch : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(Constant.HomeFolder + "App_Plan/Transaction/PlanOrderToolsDivision.aspx?loid=" + ((LinkButton)sender).CommandArgument);
    }
    ...
    private void doGetList()
    {
        ...
        gvMain.DataSource = fFlow.GetMasterList(Appz.LoggedOnUser.DIVISION, this.txtSearchPlanName.Text.Trim(), Convert.ToInt32("0" + this.txtSearchBudgetYear.Text),
