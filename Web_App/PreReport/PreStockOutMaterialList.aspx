<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreStockOutMaterialList.aspx.cs" Inherits="PreReport_PreStockOutMaterialList" Title="SHND : Pre Stock Out Material List" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <table width="810px" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="headtext">
                &nbsp;รายงานสรุปรายการวัสดุอาหารที่จ่ายออก
            </td>
        </tr>
    </table>
