...
/// </summary>
/// 
public partial class Search_DiseaseCategoryPopup_Meal : System.Web.UI.UserControl
{
        ...
        for (int i = 0; i < gvMain.Rows.Count; i++)
        {
            if (i > -1 && gvMain.Rows[i].Cells[0].FindControl("chkSelect") != null)
            {
                ...
                if (((CheckBox)gRow.Cells[1].FindControl("chkSelect")).Checked)
                {
                    ...
                    DropDownList cmbMeal = (DropDownList)gRow.Cells[21].FindControl("cmbMeal");
                    ...
                    VDiseaseCategory.MEAL = cmbMeal.SelectedValue;
                    VDiseaseCategory.MEALNAME = cmbMeal.SelectedItem.Text;
    ...
    public void Show(bool isAbstain, bool isNeed, bool isRequest, string cDiseaseCategory, string existKeyList)
    {
        ...
        this.gvMain.Columns[21].Visible = false;
