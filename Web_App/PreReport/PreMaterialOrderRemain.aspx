<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreMaterialOrderRemain.aspx.cs" Inherits="PreReport_PreMaterialOrderRemain"  Title="SHND : Report - Material Order Remain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">รายงานสรุปยอดประมาณการคงเหลือ
            </td>
        </tr>
        <tr>
            <td>
