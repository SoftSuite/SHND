...
{
    /// <summary>
    /// Represents a transaction for HOLIDAY table.
    ...
    public class HolidayDAL
    {
        ...
        private const string tableName = "HOLIDAY";
        ...
        /// <summary>
        /// Returns an indication whether the record of HOLIDAY by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of HOLIDAY by specified HOLIDAY key is retrieved successfully.
        /// </summary>
        /// <param name="cHOLIDAY">The HOLIDAY key.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        public bool GetDataByHOLIDAY(DateTime cHOLIDAY, OracleTransaction trans)
        {
            return doGetdata("HOLIDAY = " + DB.SetDateTime(cHOLIDAY) + " ", trans);
        }

        /// <summary>
        /// Returns an indication whether the record of HOLIDAY by specified NAME key is retrieved successfully.
        /// </summary>
        ...
        public bool chkDupData(DateTime cHOLIDAY, double cLOID, OracleTransaction trans)
        {
            return doGetdata("HOLIDAY = " + DB.SetDateTime(cHOLIDAY) + " AND LOID <> " + DB.SetDouble(cLOID) + " ",null);
        }
        ...
        /// <summary>
        /// Gets the insert statement for HOLIDAY table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ACTIVE, CREATEBY, CREATEON, HOLIDAY, LOID, NAME) ";
                sql += "VALUES (";
                sql += DB.SetString(_ACTIVE) + ", ";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDateTime(_HOLIDAY) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for HOLIDAY table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "HOLIDAY = " + DB.SetDateTime(_HOLIDAY) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for HOLIDAY table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for HOLIDAY table.
        /// </summary>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["HOLIDAY"])) _HOLIDAY = Convert.ToDateTime(zRdr["HOLIDAY"]);
