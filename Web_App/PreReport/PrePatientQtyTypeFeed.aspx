<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PrePatientQtyTypeFeed.aspx.cs" Inherits="PreReport_PrePatientQtyTypeFeed"  Title="SHND : Patient Qty Type Feed"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">รายงานสรุปผู้ป่วยตามประเภทการให้อาหาร
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="600">
                    ...
                    <tr style="height:24px">
                        <td style="width:130px; padding-right:10px" align="right">
                            ประเภทการให้อาหาร :</td>
                        <td>
                            <asp:DropDownList ID="cmbFeedName" runat="server" CssClass="zComboBox" Width="206px">
                                <asp:ListItem Value="">ทั้งหมด</asp:ListItem>
                                <asp:ListItem Value="M">ทางปาก</asp:ListItem>
                                <asp:ListItem Value="T">ทางสายให้อาหาร</asp:ListItem>
                            </asp:DropDownList></td>
                    </tr> 
                    <tr style="height:24px">
                        <td style="width:130px; padding-right:10px" align="right">
                    ...
                    <tr style="height:24px">
                        <td style="width:130px; padding-right:10px" align="right">
                            ควบคุม :</td>
                        <td><asp:TextBox ID="txtControl" runat="server" CssClass="zTextbox"
                    ...
                    <tr style="height:24px">
                        <td style="width:130px; padding-right:10px" align="right">
                            คำนวณแคลอรี่ :</td>
                        <td><asp:TextBox ID="txtCalorie" runat="server" CssClass="zTextbox"
                                Width="200px"></asp:TextBox>
                            </td>
                    </tr> 
                    <tr style="height:24px">
                        <td style="width:130px; padding-right:10px" align="right">
                            จำกัดปริมาณ :</td>
                        <td><asp:TextBox ID="txtLimit" runat="server" CssClass="zTextbox"
                                Width="200px"></asp:TextBox>
                            </td>
                    </tr> 
                    <tr style="height:24px">
