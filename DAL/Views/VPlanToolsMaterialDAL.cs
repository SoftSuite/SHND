...
{
    /// <summary>
    /// Represents a transaction for V_PLAN_TOOLS_MATERIAL view.
    /// [Created by 127.0.0.1 on Febuary,16 2009]
    /// </summary>
    public class VPlanToolsMaterialDAL
    {

        public VPlanToolsMaterialDAL()
        {
        }

        #region Constant

        /// <summary>V_PLAN_TOOLS_MATERIAL</summary>
        private const string viewName = "V_PLAN_TOOLS_MATERIAL";
        ...
        /// <summary>
        /// Gets the select statement for V_PLAN_TOOLS_MATERIAL table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_PLAN_TOOLS_MATERIAL by specified condition is retrieved successfully.
        /// </summary>
