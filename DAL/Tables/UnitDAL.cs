...
{
    /// <summary>
    /// Represents a transaction for UNIT table.
    ...
    public class UnitDAL
    {
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into UNIT table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to UNIT table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from UNIT table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of UNIT by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of UNIT by specified CODE key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of UNIT by specified ENNAME key is retrieved successfully.
        /// </summary>
        /// <param name="cENNAME">The ENNAME key.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        public bool GetDataByENNAME(string cENNAME, OracleTransaction trans)
        {
            return doGetdata("ENNAME = " + DB.SetString(cENNAME) + " ", trans);
        }

        /// <summary>
        /// Returns an indication whether the record of UNIT by specified THNAME key is retrieved successfully.
        /// </summary>
        /// <param name="cTHNAME">The THNAME key.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        public bool GetDataByTHNAME(string cTHNAME, OracleTransaction trans)
        {
            return doGetdata("THNAME = " + DB.SetString(cTHNAME) + " ", trans);
        }

        public DataTable GetDataList_ByField(string whereClause, string orderBy, OracleTransaction trans)
        {
            return DB.ExecuteTable(sql_select_ByField + (whereClause == "" ? "" : "WHERE " + whereClause + " ") + (orderBy == "" ? "" : "ORDER BY " + DB.SetSortString(orderBy)), trans);
        }
        ...
        /// <summary>
        /// Gets the insert statement for UNIT table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ABBNAME, ACTIVE, CODE, CREATEBY, CREATEON, ENNAME, LOID, THNAME) ";
                sql += "VALUES (";
                ...
                sql += DB.SetString(_ENNAME) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetString(_THNAME) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for UNIT table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "ENNAME = " + DB.SetString(_ENNAME) + ", ";
                sql += "THNAME = " + DB.SetString(_THNAME) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for UNIT table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for UNIT table.
        /// </summary>
        ...
        private string sql_select_ByField
        {
            get
            {
                string sql = "SELECT LOID,CODE,THNAME,ENNAME,ACTIVE,CREATEON,CREATEBY,UPDATEON, ";
                sql += " UPDATEBY,CASE WHEN ACTIVE = 1 THEN 'ใช้งาน' ELSE 'ไม่ใช้งาน' END ACTIVENAME ";
                sql += " FROM " + tableName + " ";
                return sql;
            }
        }

        private string sql_lastcode
        {
            get
            {
                string sql = "SELECT VALUE FROM RUNNING WHERE RUNNING = '" + tableName + "' ";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Returns an indication whether the record of UNIT by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["ENNAME"])) _ENNAME = zRdr["ENNAME"].ToString();
