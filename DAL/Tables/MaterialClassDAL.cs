...
{
    /// <summary>
    /// Represents a transaction for MATERIALCLASS table.
    /// [Created by 127.0.0.1 on January,22 2009]
    /// </summary>
    public class MaterialClassDAL
    {

        public MaterialClassDAL()
        {
        }

        #region Constant

        /// <summary>MATERIALCLASS</summary>
        private const string tableName = "MATERIALCLASS";
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to MATERIALCLASS table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from MATERIALCLASS table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of MATERIALCLASS by specified CODE key is retrieved successfully.
        /// </summary>
        ...
        public bool UpdateDataByLOID(double cLOID, OracleTransaction trans)
        {
        ...
        /// <summary>
        /// Gets the insert statement for MATERIALCLASS table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ACTIVE, CODE, CREATEBY, CREATEON, LOID, MASTERTYPE, NAME, STOCKINTYPE) ";
                sql += "VALUES (";
                ...
                sql += DB.SetString(_MASTERTYPE) + ", ";
                sql += DB.SetString(_NAME) + ", ";
                sql += DB.SetString(_STOCKINTYPE) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for MATERIALCLASS table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "MASTERTYPE = " + DB.SetString(_MASTERTYPE) + ", ";
                sql += "NAME = " + DB.SetString(_NAME) + ", ";
                sql += "STOCKINTYPE = " + DB.SetString(_STOCKINTYPE) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for MATERIALCLASS table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for MATERIALCLASS table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of MATERIALCLASS by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
