...
{
    /// <summary>
    /// Represents a transaction for PLANMATERIALCLASS table.
    /// [Created by 127.0.0.1 on January,30 2009]
    /// </summary>
    public class PlanMaterialClassDAL
    {

        public PlanMaterialClassDAL()
        {
        }

        #region Constant

        /// <summary>PLANMATERIALCLASS</summary>
        private const string tableName = "PLANMATERIALCLASS";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into PLANMATERIALCLASS table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to PLANMATERIALCLASS table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from PLANMATERIALCLASS table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of PLANMATERIALCLASS by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for PLANMATERIALCLASS table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CONTRACTCODE, CREATEBY, CREATEON, LOID, MATERIALCLASS, PLANORDER, REMARKS, SUPPLIER) ";
                sql += "VALUES (";
        ...
        /// <summary>
        /// Gets the update statement for PLANMATERIALCLASS table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the delete statement for PLANMATERIALCLASS table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for PLANMATERIALCLASS table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PLANMATERIALCLASS by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        public bool DeleteDataByConditions(double cPLANORDER, string exceptMaterialClass, OracleTransaction trans)
        {
            return doDelete("PLANORDER = " + DB.SetDouble(cPLANORDER) + (exceptMaterialClass == "" ? "" : (" AND MATERIALCLASS NOT IN (" + exceptMaterialClass + ")")), trans);
        }

        public bool GetDataByConditions(double cPLANORDER, double cMATERIALCLASS, OracleTransaction trans)
        {
            return doGetdata("PLANORDER = " + DB.SetDouble(cPLANORDER) + " AND MATERIALCLASS  =" + DB.SetDouble(cMATERIALCLASS), trans);
        }
        public DataTable GetDataListByPlanOrder(double cPLANORDER, OracleTransaction trans)
        {
            return GetDataList("PLANORDER = " + DB.SetDouble(cPLANORDER) + " ", "", trans);
        }
