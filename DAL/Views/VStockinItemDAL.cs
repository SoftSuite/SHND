...
{
    /// <summary>
    /// Represents a transaction for V_STOCKINITEM view.
    /// [Created by 127.0.0.1 on March,3 2009]
    /// </summary>
    public class VStockinItemDAL
    {

        public VStockinItemDAL()
        {
        }

        #region Constant

        /// <summary>V_STOCKINITEM</summary>
        private const string viewName = "V_STOCKINITEM";
        ...
        /// <summary>
        /// Gets the select statement for V_STOCKINITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_STOCKINITEM by specified condition is retrieved successfully.
        /// </summary>
