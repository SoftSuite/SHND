...
public partial class PreReport_PreStockoutLoseMaterial : System.Web.UI.Page
{
    ...
    private void SetReportScript()
    {
        ...
        if (rbtType.SelectedValue == "dd")
        {
            ...
            "else { " + Appz.OpenReportScript(Constant.Reports.StockOutLoseMaterialDate, scriptD, true) + "} ";
        ...
        else if (rbtType.SelectedValue == "mm")
        {
            ...
            "else if (document.getElementById('" + this.cmbMaterial.ClientID + "').value != '0' & document.getElementById('" + this.cmbUnit.ClientID + "').value == '0') " +
            "{ alert('" + string.Format(DataResources.MSGEI002, "หน่วย") + "'); return false; } " +
            "else { " + Appz.OpenReportScript(Constant.Reports.StockOutLoseMaterialMonth, scriptM, true) + "} ";
        ...
        else
        {
            ...
            "else if (document.getElementById('" + this.cmbMaterial.ClientID + "').value != '0' & document.getElementById('" + this.cmbUnit.ClientID + "').value == '0') " +
            "{ alert('" + string.Format(DataResources.MSGEI002, "หน่วย") + "'); return false; } " +
            "else { " + Appz.OpenReportScript(Constant.Reports.StockOutLoseMaterialYear, scriptY, true) + "} ";
