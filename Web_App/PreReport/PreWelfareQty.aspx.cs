...
/// Remark: -
/// Description:
///    หน้าการทำรายการข้อมูล PreWelFareQty
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
public partial class PreReport_PreWelfareQty : System.Web.UI.Page
{
    ...
    protected void tbPrintClick(object sender, EventArgs e)
    {
        if (rdDay.Checked)
        {
            ...
            else
            {
                ...
                string script = OpenReportScript(Constant.Reports.WelfareQtyDayReport, "paramfield1=division&paramvalue1=" + cmbDivision.SelectedItem.Value  +
        ...
        else if (rdMonth.Checked)
        {
            ...
            else
            {
                ...
                string script = OpenReportScript(Constant.Reports.WelfareQtyMonthReport, "paramfield1=division&paramvalue1=" + cmbDivision.SelectedItem.Value +
               "&paramfield2=reqdivision&paramvalue2=" + cmbReqDivision.SelectedItem.Value +
        ...
        else if (rdYear.Checked)
        {
            ...
            {
                string script = OpenReportScript(Constant.Reports.WelfareQtyYearReport, "paramfield1=division&paramvalue1=" + cmbDivision.SelectedItem.Value +
               "&paramfield2=reqdivision&paramvalue2=" + cmbReqDivision.SelectedItem.Value +
