<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="StockOutRequestSearch.aspx.cs" Inherits="App_Inventory_Transaction_StockOutRequestSearch" Title="SHND : Transaction - Stock out Requisition" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                ...
                <uc1:ToolBarItemCtl ID="tbDelete" runat="server" ToobarTitle="ลบข้อมูลที่เลือก" OnClick="tbDeleteClick" ToolbarImage="../../Images/icn_Delete.png"  />
                <uc1:ToolBarItemCtl ID="tbSend" runat="server" ToobarTitle="ส่งข้อมูล" OnClick="tbSendClick" ToolbarImage="../../Images/icn_send.png"  />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <legend style="font-weight:bold">
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="800">
                    ...
                    <tr style="height:24px">
                        <td style="width:119px; text-align: right; padding-right:10px">
                            เลขที่เบิก :</td>
                    ...
                    <tr style="height:24px">
                        <td style="padding-right: 10px; width: 119px; text-align: right">
                            วันที่ใช้ :</td>
                        <td style="width: 150px">
