...
{
    /// <summary>
    /// Represents a transaction for PREPAREWEIGHTAFTER table.
    /// [Created by 10.10.10.10 on May,14 2009]
    /// </summary>
    public class PrepareWeightAfterDAL
    {

        public PrepareWeightAfterDAL()
        {
        }

        #region Constant

        /// <summary>PREPAREWEIGHTAFTER</summary>
        private const string tableName = "PREPAREWEIGHTAFTER";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into PREPAREWEIGHTAFTER table successfully.
        /// </summary>
        ...
        public bool InsertCurrentData(string userID, OracleTransaction trans)
        {
            ...
            _CODE = DB.GetRunningCode("PREPAREWEIGHTAFTER", "CODE", trans);
            _CREATEBY = userID;
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to PREPAREWEIGHTAFTER table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from PREPAREWEIGHTAFTER table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPAREWEIGHTAFTER by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPAREWEIGHTAFTER by specified CODE key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for PREPAREWEIGHTAFTER table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CODE, CREATEBY, CREATEON, LOID, MATERIALCLASS, PREPAREDATE, STATUS) ";
                sql += "VALUES (";
                ...
                sql += DB.SetDateTime(_PREPAREDATE) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for PREPAREWEIGHTAFTER table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "PREPAREDATE = " + DB.SetDateTime(_PREPAREDATE) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for PREPAREWEIGHTAFTER table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for PREPAREWEIGHTAFTER table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PREPAREWEIGHTAFTER by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        {
            string sql = "";
            sql = "SELECT PKE_PREPARE.FN_CALPREPAREWEIGHSTD(TO_DATE('" + date + "','YYYYMMDD'), " + materialclass + ", '" + type + "') FROM DUAL";
        ...
        {
            string sql = "";
            sql = "SELECT * FROM PREPAREWEIGHTAFTER WHERE MATERIALCLASS = " + materialclass + " AND TO_CHAR(PREPAREDATE,'YYYY/MM/DD') = '" + date + "'";
