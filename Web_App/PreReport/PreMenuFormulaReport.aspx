<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreMenuFormulaReport.aspx.cs" Inherits="PreReport_PreMenuFormulaReport"  Title="SHND : Menu Formula " %>
                   ...
                   <tr style="height:24px">
                    ...
                    <tr style="height:24px">
                        <td style="width:130px; padding-right:10px" align="right">
                            เวลาเตรียม :</td>
                        <td>
                            <asp:TextBox ID="txtTimeFrom" ReadOnly="true" CssClass="zTextbox-View" runat="server" Width="50px" ></asp:TextBox>
                            &nbsp;ถึง
                            <asp:TextBox ID="txtTimeTo" ReadOnly="true" CssClass="zTextbox-View" runat="server" Width="50px" ></asp:TextBox>&nbsp; [Ex.08:00]
                        </td>
                    </tr>
                                        <tr style="height:24px">
                        <td style="width:130px; padding-right:10px" align="right">
