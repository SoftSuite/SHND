...
public partial class PreReport_PreCompareInterest : System.Web.UI.Page
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        this.tbPrint.ClientClick = Appz.OpenReportScript(Constant.Reports.CompareInterest, "paramfield1=material&paramvalue1=' + document.getElementById('" + this.txtMaterial.ClientID + "').value + '" +
