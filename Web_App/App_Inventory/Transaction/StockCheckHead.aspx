...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr class="zHidden">
         ...
         <tr>
            <td>
                <uc1:ToolBarItemCtl ID="ToolBarItemCtl4" runat="server" ToobarTitle="อนุมัติ"   ToolbarImage="../../Images/icn_approve.png" OnClick ="tbApproveMain_Click"  ClientClick="return confirm('ต้องการอนุมัติรายการที่เลือก ใช่หรือไม่?')"    />
                <uc1:ToolBarItemCtl ID="ToolBarItemCtl5" runat="server" ToobarTitle="ยกเลิก" ToolbarImage="../../Images/icn_cancel.png" OnClick ="tbCancelMain_Click" ClientClick="return confirm('ต้องการยกเลิกรายการที่เลือก ใช่หรือไม่?')"  />
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" style="display:none" Width="800px">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td>
                    <uc1:ToolBarItemCtl ID="tbApprove" runat="server" ToobarTitle="อนุมัติ" ToolbarImage="../../Images/icn_approve.png" OnClick= "tbApprove_Click" />
                    <uc1:ToolBarItemCtl ID="tbCancel" runat ="server" ToolbarImage="../../Images/icn_cancel.png" ToobarTitle ="ยกเลิก" OnClick= "tbCancel_Click" ClientClick="return confirm('ต้องการยกเลิกรายการ ใช่หรือไม่?')" />
                        ...
                        <tr>
                            <td valign="top" style="padding:5px; border-right: 1px solid; border-top: 1px solid; border-left: 1px solid; border-bottom: 1px solid; width:550px">
                                <table cellpadding="0" cellspacing="0" width="550" >
                                     <tr>
                                        <td align="right" style="padding-right: 10px; width: 126px; height: 24px"  > เลขที่การตรวจนับ :</td>
                                    ...
                                    <tr>
                                        <td align="right" style="padding-right: 10px; width: 126px; height: 24px" >คลังที่ตรวจนับ :</td>
                                        <td colspan="3" style="height: 24px" >
