...
{
    /// <summary>
    /// Represents a transaction for MENUDATE table.
    /// [Created by 127.0.0.1 on January,21 2009]
    /// </summary>
    public class MenuDateDAL
    {
        ...
        /// <summary>MENUDATE</summary>
        private const string tableName = "MENUDATE";
        ...
        public bool GetDataByCondition(double cMENU, DateTime cMENUDATE, OracleTransaction trans)
        {
            return doGetdata("MENU = " + DB.SetDouble(cMENU) + " AND MENUDATE = " + DB.SetDateTime(cMENUDATE) + " ", trans);
        }

        /// <summary>
        /// Returns an indication whether the current data is inserted into MENUDATE table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to MENUDATE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from MENUDATE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of MENUDATE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        {
            return doGetdata("MENU = " + DB.SetDouble(cMENU) + " ", trans);
        }
        ...
        /// <summary>
        /// Gets the insert statement for MENUDATE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, LOID, MENU, MENUDATE, PORTION) ";
                sql += "VALUES (";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetDouble(_MENU) + ", ";
                sql += DB.SetDateTime(_MENUDATE) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for MENUDATE table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "MENUDATE = " + DB.SetDateTime(_MENUDATE) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for MENUDATE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for MENUDATE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of MENUDATE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
