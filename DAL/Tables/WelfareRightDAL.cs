...
{
    /// <summary>
    /// Represents a transaction for WELFARERIGHT table.
    /// [Created by 127.0.0.1 on August,11 2009]
    /// </summary>
    public class WelfareRightDAL
    {

        public WelfareRightDAL()
        {
        }

        #region Constant

        /// <summary>WELFARERIGHT</summary>
        private const string tableName = "WELFARERIGHT";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into WELFARERIGHT table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to WELFARERIGHT table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from WELFARERIGHT table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of WELFARERIGHT by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for WELFARERIGHT table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, LOID, QTYDATE, RIGHTMONTH, RIGHTYEAR) ";
                sql += "VALUES (";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetDouble(_QTYDATE) + ", ";
                sql += DB.SetString(_RIGHTMONTH) + ", ";
                sql += DB.SetDouble(_RIGHTYEAR) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for WELFARERIGHT table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "QTYDATE = " + DB.SetDouble(_QTYDATE) + ", ";
                sql += "RIGHTMONTH = " + DB.SetString(_RIGHTMONTH) + ", ";
                sql += "RIGHTYEAR = " + DB.SetDouble(_RIGHTYEAR) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for WELFARERIGHT table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for WELFARERIGHT table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of WELFARERIGHT by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
