    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td>
                ...
                <uc1:ToolBarItemCtl ID="tbVoid" runat="server" ToobarTitle="ยกเลิก" ToolbarImage="../../Images/icn_delete.png" OnClick="tbVoidClick" />
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="600">
                                ...
                                <tr style="height:24px">
                                    ...
                                    <td style="width:100px; text-align:right; padding-right:10px">
                                        มื้อที่ใช้ :</td> 
                                    <td>
                                        <asp:CheckBox ID="chkIsBreakfast" runat="server" Text="เช้า" Enabled="False" />
                                        <asp:CheckBox ID="chkIsLunch" runat="server" Text="กลางวัน" Enabled="False" />
                                        <asp:CheckBox ID="chkIsDinner" runat="server" Text="เย็น" Enabled="False" /></td> 
                                </tr>
                            </table>
                        </td>
                        <td style="width:4px">&nbsp;
            ...
            <td>
                <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle" Width="100%" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="จำนวน&lt;br&gt;ที่จ่าย">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="อนุมัติ">
                            <HeaderTemplate>
                                <asp:Label ID="lbApprove" runat="server" Text="อนุมัติ"></asp:Label><input type="checkbox" title="อนุมัติ" name="chkMain" id="chkMain" onclick="chkAllBox(this, 'ctl00_MainContent_gvMain_ctl', '_chkApprove')" />
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="REMAIN" HeaderText="จำนวนคงคลัง" SortExpression="REMAIN" HtmlEncode="False" DataFormatString="{0:#,##0.00}">
                            <HeaderStyle Width="100px" />
                            <ItemStyle Width="100px" HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TOTAL" HeaderText="จำนวนเงิน" SortExpression="TOTAL" HtmlEncode="False" DataFormatString="{0:#,##0.00}">
                            <HeaderStyle Width="100px" />
                            <ItemStyle Width="100px" HorizontalAlign="Right" />
                        </asp:BoundField>
