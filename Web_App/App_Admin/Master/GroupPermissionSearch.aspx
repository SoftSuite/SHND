        ...
        <tr>
            ...
            <legend style="font-weight:bold">
             ...
             <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td style="width:120px; text-align: right; padding-right:10px">ชื่อกลุ่ม</td>
        ...
        <tr>
            <td >
                <uc2:PageControl ID="pcTop" runat="server"  Visible = "false" OnPageChange="PageChange" />
                   <asp:GridView ID="gvMain" runat="server" AllowSorting="True"  class="t_tablestyle"  EmptyDataText="<center>***ไม่พบข้อมูล***</center>"  AutoGenerateColumns="False" CssClass="t_tablestyle"   OnRowDataBound="gvMain_RowDataBound" OnSorting="gvMain_Sorting"  AllowPaging="True" PageSize="20" style="width:100%;" >
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="ชื่อกลุ่ม" SortExpression="DESCRIPTION">
                            <ItemTemplate>                      
                        ...
                        <asp:BoundField  DataField="MENUCOUNT" HeaderText="จำนวนเมนู" SortExpression="MENUCOUNT">
            ...
            <td style="height: 198px">
                <table cellpadding="5">
                    <tr>
                     ...
                     <tr>
                        <td style="width:169px" align="right"> ชื่อกลุ่ม  </td>
