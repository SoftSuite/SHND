...
{
    /// <summary>
    /// Represents a transaction for ZROLE table.
    /// [Created by 127.0.0.1 on Febuary,3 2009]
    /// </summary>
    public class ZRoleDAL
    {
        ...
        /// <summary>ZROLE</summary>
        private const string tableName = "ZROLE";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into ZROLE table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to ZROLE table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from ZROLE table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of ZROLE by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for ZROLE table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, DESCRIPTION, LOID, OFFICER, ZLEVEL) ";
                sql += "VALUES (";
        ...
        /// <summary>
        /// Gets the update statement for ZROLE table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "ZLEVEL = " + DB.SetString(_ZLEVEL) + " ";
                return sql;
            }
        }

        /// <summary>
        /// Gets the delete statement for ZROLE table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for ZROLE table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of ZROLE by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        public bool GetDataByOfficer(double cOfficer, OracleTransaction trans)
        {
            return doGetdata("OFFICER = " + DB.SetDouble(cOfficer) + " ", trans);
        }

        public DataTable GetAllRoleGroup()
        {
            return DB.ExecuteTable(" SELECT * FROM ZROLE WHERE ZLEVEL = 'G' ");
        }
