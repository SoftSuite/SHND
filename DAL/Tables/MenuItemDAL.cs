...
{
    /// <summary>
    /// Represents a transaction for MENUITEM table.
    ...
    public class MenuItemDAL
    {
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into MENUITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to MENUITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from MENUITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of MENUITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        public bool GetDataByMenu(double cMENU, OracleTransaction trans)
        {
            return doGetdata("MENUDATE IN (SELECT LOID FROM MENUDATE WHERE MENU = " + DB.SetDouble(cMENU) + ") ", trans);
        }

        public bool DeleteDataByMenu(double cMENU, OracleTransaction trans)
        {
            return doDelete("MENUDATE IN (SELECT LOID FROM MENUDATE WHERE MENU = " + DB.SetDouble(cMENU) + ") ", trans);
        }

        public bool DeleteDataByConditions(double cMENU, string cMEAL, DateTime cMENUDATE, OracleTransaction trans)
        {
            return doDelete("MEAL = " + DB.SetString(cMEAL) + " AND MENUDATE IN (SELECT LOID FROM MENUDATE WHERE MENU = " + DB.SetDouble(cMENU) + " AND MENUDATE = " + DB.SetDateTime(cMENUDATE) + ") ", trans);
        }
        ...
        /// <summary>
        /// Gets the insert statement for MENUITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, FORMULASET, GROUPTYPE, LOID, MATERIALMASTER, MEAL, MENUDATE, QTY, UNIT) ";
                sql += "VALUES (";
        ...
        /// <summary>
        /// Gets the update statement for MENUITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the delete statement for MENUITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for MENUITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of MENUITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
