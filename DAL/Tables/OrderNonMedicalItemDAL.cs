...
{
    /// <summary>
    /// Represents a transaction for ORDERNONMEDICALITEM table.
    /// [Created by 127.0.0.1 on March,12 2009]
    /// </summary>
    public class OrderNonMedicalItemDAL
    {

        public OrderNonMedicalItemDAL()
        {
        }

        #region Constant

        /// <summary>ORDERNONMEDICALITEM</summary>
        private const string tableName = "ORDERNONMEDICALITEM";
        ...
        public double ORDERNONMEDICALDIET
        {
            get { return _ORDERNONMEDICALDIET; }
            set { _ORDERNONMEDICALDIET = value; }
        }
        public double QTY
        {
            get { return _QTY; }
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into ORDERNONMEDICALITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to ORDERNONMEDICALITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from ORDERNONMEDICALITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of ORDERNONMEDICALITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for ORDERNONMEDICALITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, DISEASECATEGORY, ISHIGH, ISLOW, ISNON, LOID, ORDERNONMEDICALDIET, QTY, UNIT) ";
                sql += "VALUES (";
                ...
                sql += DB.SetDouble(_ORDERNONMEDICALDIET) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for ORDERNONMEDICALITEM table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "ORDERNONMEDICALDIET = " + DB.SetDouble(_ORDERNONMEDICALDIET) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for ORDERNONMEDICALITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for ORDERNONMEDICALITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of ORDERNONMEDICALITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["ORDERNONMEDICALDIET"])) _ORDERNONMEDICALDIET = Convert.ToDouble(zRdr["ORDERNONMEDICALDIET"]);
        ...
        public bool DeleteDataByConditions(double cORDERNONMEDICALDIET, string exceptDiseaseCategoryList, OracleTransaction trans)
        {
            return doDelete("ORDERNONMEDICALDIET = " + DB.SetDouble(cORDERNONMEDICALDIET) + (exceptDiseaseCategoryList == "" ? "" : (" AND DISEASECATEGORY NOT IN (" + exceptDiseaseCategoryList + ")")), trans);
        }

        public bool GetDataByConditions(double cORDERNONMEDICALDIET, double cDISEASECATEGORY, OracleTransaction trans)
        {
            return doGetdata("ORDERNONMEDICALDIET = " + DB.SetDouble(cORDERNONMEDICALDIET) + " AND DISEASECATEGORY = " + DB.SetDouble(cDISEASECATEGORY), trans);
        }
