...
{
    /// <summary>
    /// Represents a transaction for MEDFEEDCHARGEITEM table.
    /// [Created by 127.0.0.1 on May,14 2009]
    /// </summary>
    public class MedFeedChargeItemDAL
    {

        public MedFeedChargeItemDAL()
        {
        }

        #region Constant

        /// <summary>MEDFEEDCHARGEITEM</summary>
        private const string tableName = "MEDFEEDCHARGEITEM";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into MEDFEEDCHARGEITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to MEDFEEDCHARGEITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from MEDFEEDCHARGEITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of MEDFEEDCHARGEITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for MEDFEEDCHARGEITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ADMITPATIENT, CREATEBY, CREATEON, LOID, MATERIALMASTER, MEDFEEDCHARGE, PRICE, QTY, REMARKS, REQDATE, UNIT) ";
                sql += "VALUES (";
        ...
        /// <summary>
        /// Gets the update statement for MEDFEEDCHARGEITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the delete statement for MEDFEEDCHARGEITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for MEDFEEDCHARGEITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of MEDFEEDCHARGEITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["MEDFEEDCHARGE"])) _MEDFEEDCHARGE = Convert.ToDouble(zRdr["MEDFEEDCHARGE"]);
                        ...
                        if (!Convert.IsDBNull(zRdr["REQDATE"])) _REQDATE = Convert.ToDateTime(zRdr["REQDATE"]);
        ...
        public bool DeleteNotInLOIDList(string mfiloidlist, string medfeedcharge_loid, OracleTransaction trans)
        {
            string whrStr = "";
            if (mfiloidlist != "")
                whrStr = "MEDFEEDCHARGE = " + medfeedcharge_loid + " AND LOID NOT IN (" + mfiloidlist + ")";
            else
                whrStr = "MEDFEEDCHARGE = " + medfeedcharge_loid;
        ...
        private string sql_field
        {
            get
            {
                string sql = " SELECT MCI.LOID MCILOID, MCI.MEDFEEDCHARGE MCLOID,AP.PATIENTNAME,AP.LOID, MCI.MATERIALMASTER MMLOID, ";
                       sql += " MCI.UNIT UULOID, VM.UNITNAME UUNAME, MCI.REQDATE, VM.MATERIALNAME MMNAME, NVL(MCI.QTY,0) QTY, ";
                       sql += " NVL(MCI.PRICE,0) PRICE, MCI.REMARKS, NVL(MCI.PRICE,0) * NVL(MCI.QTY,0) AS TOTAL ";
                       sql += " FROM MEDFEEDCHARGEITEM MCI INNER JOIN V_ADMITPATIENT AP ON MCI.ADMITPATIENT = AP.LOID ";
                       sql += " LEFT JOIN V_MATERIALMASTER_UNIT VM ON VM.MATERIALMASTER = MCI.MATERIALMASTER ";
                return sql;
            }
        }


        public DataTable GetFieldList(string whereClause, string orderBy, OracleTransaction trans)
        {
