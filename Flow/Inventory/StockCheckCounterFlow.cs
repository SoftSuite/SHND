...
/// Remark: -
/// Description:
///    Flow จัดการการทำงานของหน้า StockCheckCounter
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
{
    public class StockCheckCounterFlow
    {
        string _error = "";
        ...
        #region CheckUniqe
        public bool CheckUniqe(string str_value, double cLOID,string field)
        {
            StockCheckDAL sDAL = new StockCheckDAL();
            sDAL.GetDataByUniq("" + field + " = " + str_value + "", null);
            return !sDAL.OnDB || (cLOID.ToString() == sDAL.LOID.ToString());
        }
        ...
        public bool InsertStockCheckItem(DataTable  dt, double sLoid, string UserID)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    StockCheckItemDAL siDAL = new StockCheckItemDAL(); 
                    {
                        siDAL.STOCKCHECK = Convert.ToDouble("0" + sLoid.ToString());
        ...
        public bool UpdateStockCheckItem(DataTable dt, string UserID)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    siDAL.ISIMPROVE = (dt.Rows[i]["ISIMPROVE"].ToString() == ""  ? "N" : dt.Rows[i]["ISIMPROVE"].ToString());
        ...
        private bool CheckDelete(ArrayList arr)
        {
            ...
            {
                if (sDAL.CheckDelete(Convert.ToDouble(arr[i]),null) != "WA")
                {
