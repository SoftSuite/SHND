<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PlanOrderToolsDivision.aspx.cs" Inherits="App_Plan_Transaction_PlanOrderToolsDivision" Title="SHND : Transaction - Tool Order Planning" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="520">
                                ...
                                <tr style="height: 24px">
                                    ...
                                    <td colspan="3" style="height: 24px">
                                        <asp:TextBox ID="txtName" runat="server" CssClass="zTextbox-View" Width="320px" MaxLength="100" ReadOnly="true"></asp:TextBox></td>
                                </tr>
                                <tr style="height: 24px">
                                ...
                                <tr style="height: 24px">
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtClassName" runat="server" CssClass="zTextbox-View" MaxLength="100"
                                            ReadOnly="true" Width="320px"></asp:TextBox></td>
                                </tr>
                            </table>
                        </td>
        ...
        <tr>
            <td>
                <asp:GridView ID="gvMaterial" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle" Width="100%">
                    <Columns>
