...
/// Remark: -
/// Description:
///    หน้าการทำรายการข้อมูล PreStockInMaterial
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
...
public partial class PreReport_PreStockinMaterial : System.Web.UI.Page
{
    ...
    {
        base.OnInit(e);
        Appz.BuildCombo(cmbStockInType, "DOCTYPE", "DOCNAME", "LOID", "TYPE = 'I' AND ISSTOCKIN = 'Y'", "NAME", "ทั้งหมด", "0",true);
    ...
    protected void tbPrintClick(object sender, EventArgs e)
    {
        ...
        if (rdDay.Checked)
        {
            ...
            else
            {
                ...
                string script = OpenReportScript(Constant.Reports.StockinMaterialDayReport, "paramfield1=class&paramvalue1=" + cmbMaterialClass.SelectedItem.Value +
               ...
               "&paramfield7=datetothai&paramvalue7=" + strToTh, false);
        ...
        else if (rdMonth.Checked)
        {
            ...
            else
            {
                ...
                string script = OpenReportScript(Constant.Reports.StockinMaterialMonthReport, "paramfield1=class&paramvalue1=" + cmbMaterialClass.SelectedItem.Value +
               "&paramfield2=material&paramvalue2=" + cmbMaterialMaster.SelectedItem.Value +
               "&paramfield3=v_unit&paramvalue3=" + cmbUnit.SelectedItem.Value +
               ...
               "&paramfield7=myto&paramvalue7=" + Server.UrlEncode(myto), false);
        ...
        else if (rdYear.Checked)
        {
            ...
            {
                CheckRadio();
                string script = OpenReportScript(Constant.Reports.StockinMaterialYearReport, "paramfield1=class&paramvalue1=" + cmbMaterialClass.SelectedItem.Value +
               "&paramfield2=material&paramvalue2=" + cmbMaterialMaster.SelectedItem.Value +
               "&paramfield3=v_unit&paramvalue3=" + cmbUnit.SelectedItem.Value +
               "&paramfield4=yearfrom&paramvalue4=" + (txtYearFrom.Text.Trim() == "" ? "0" : txtYearFrom.Text.Trim()) +
               "&paramfield5=yearto&paramvalue5=" + (txtYearTo.Text.Trim() == "" ? "0" : txtYearTo.Text.Trim()), false);
                ScriptManager.RegisterStartupScript(Page, GetType(), "report", "<script language='javascript'>" + script + "</script>", false);
            }
        }
