                        ...
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="500px">
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">รหัสวัสดุ :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">ชื่อวัสดุ :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">ประเภท :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">หน่วยนับ :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">น้ำหนัก(กรัม)ต่อหน่วย :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">ราคาทุน :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">ราคาขาย :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">วิธีการรับเข้า :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">หน่วยงานที่ตัดจ่าย :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chkIsCount" runat="server" Text="นับสต๊อก" Checked="true" ></asp:CheckBox> 
                                    </td> 
                                </tr>
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">ปริมาณต่ำสุด :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px">ปริมาณสูงสุด :
                                    </td> 
                                    <td>
                                ...
                                <tr style="height:24px">
                                    <td style="padding-right:10px; text-align:right; width:140px" valign="top">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100px">
                                            <tr><td style="height:24px">หมายเหตุ :</td></tr>
                                        </table>
                                    </td> 
                                    <td>
                                ...
                                <tr>
                                    <td style="padding:10px; border-right: mediumorchid thin solid; border-top: mediumorchid thin solid; border-left: mediumorchid thin solid; border-bottom: mediumorchid thin solid;">
                                        <table cellspacing="0" cellpadding="0" border="0"  >
                                            <tr style="height:24px">
                                                <td style="width: 80px; padding-right:10px" align="right">รหัส SAP :</td>
                                                <td><asp:TextBox ID="txtSAP" runat="server" CssClass="zTextbox" Width="120px"></asp:TextBox></td>
                                            </tr>
                                            <tr style="height:24px">
                                                <td style="width: 80px; padding-right:10px" align="right">รหัสครุภัณฑ์ :</td>
                                                <td><asp:TextBox ID="txtArticle" runat="server" CssClass="zTextbox" Width="120px"></asp:TextBox></td>
                                            </tr>
                                            <tr style="height:24px">
                                                <td style="width: 80px; padding-right:10px" align="right">คลัง SAP :</td>
                                                <td>
