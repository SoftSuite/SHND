...
namespace SHND.Flow.Order
{
    public class OrderWelfareFlow
    {
        ...
        {
            DivisionDAL vDAL = new DivisionDAL();
        ...
        public bool InsertData(VOrderWelfareData ftData, string UserID)
        {
            ...
            try
            {
                ...
                ftDAL.ISTIFFIN = ftData.ISTIFFIN;
        ...
        {
            VOrderWelfareDAL vDAL = new VOrderWelfareDAL();
            return vDAL.GetTiffin(division,monthfrom,yearfrom,monthto,yearto);
        }
        public string GetTiffinOver(double division, double monthfrom, double yearfrom, double monthto, double yearto)
        {
            VOrderWelfareDAL vDAL = new VOrderWelfareDAL();
            return vDAL.GetTiffinOver(division, monthfrom, yearfrom, monthto, yearto);
        }
