...
{
    /// <summary>
    /// Represents a transaction for REPAIRSTATUS table.
    /// [Created by 127.0.0.1 on Febuary,13 2009]
    /// </summary>
    public class RepairstatusDAL
    {

        public RepairstatusDAL()
        {
        }

        #region Constant

        /// <summary>REPAIRSTATUS</summary>
        private const string tableName = "REPAIRSTATUS";
        ...
        string _DESCRIPTION = "";
        double _LOID = 0;
        DateTime _REPAIRDATE = new DateTime(1, 1, 1);
        double _STOCKOUTITEM = 0;
        string _UPDATEBY = "";
        ...
        private void ClearData()
        {
            ...
            _DESCRIPTION = "";
            _LOID = 0;
            _REPAIRDATE = new DateTime(1, 1, 1);
            _STOCKOUTITEM = 0;
            _UPDATEBY = "";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into REPAIRSTATUS table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to REPAIRSTATUS table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from REPAIRSTATUS table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of REPAIRSTATUS by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for REPAIRSTATUS table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(CREATEBY, CREATEON, DESCRIPTION, LOID, REPAIRDATE, STOCKOUTITEM) ";
                sql += "VALUES (";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetString(_DESCRIPTION) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetDateTime(_REPAIRDATE) + ", ";
                sql += DB.SetDouble(_STOCKOUTITEM) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for REPAIRSTATUS table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "REPAIRDATE = " + DB.SetDateTime(_REPAIRDATE) + ", ";
                sql += "STOCKOUTITEM = " + DB.SetDouble(_STOCKOUTITEM) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for REPAIRSTATUS table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for REPAIRSTATUS table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of REPAIRSTATUS by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["REPAIRDATE"])) _REPAIRDATE = Convert.ToDateTime(zRdr["REPAIRDATE"]);
                        if (!Convert.IsDBNull(zRdr["STOCKOUTITEM"])) _STOCKOUTITEM = Convert.ToDouble(zRdr["STOCKOUTITEM"]);
        ...
        public DataTable GetGetRepairListByCondition(double loid, string orderBy, OracleTransaction trans)
        {
            //build where clause
            string whStr = "";


            if (loid != 0) whStr += (whStr.Trim() == "" ? "" : " AND ") + " STOCKOUTITEM  =   " + loid + " ";

            return GetDataList(whStr, orderBy, trans);
        }
        public bool DeleteDataByRepair(double cSTOCKOUTITEM, OracleTransaction trans)
        {
            return doDelete("STOCKOUTITEM = " + DB.SetDouble(cSTOCKOUTITEM) + " ", trans);
        }
    }
