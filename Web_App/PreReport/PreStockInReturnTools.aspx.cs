...
/// <summary>
/// PreStockInReturnTools Page Class
/// Version 1.0
/// =========================================================================
/// Create by: Teang
...
/// Remark: -
/// Description:
///    หน้าการทำรายการข้อมูล PreStockInReturnTools
/// Changes:
///    1.0 - สร้าง
/// -------------------------------------------------------------------------
/// =========================================================================
/// </summary>
/// 
public partial class PreReport_PreStockInReturnTools : System.Web.UI.Page
{
    ...
    private void SetReportScript(RadioButtonList rblType)
    {
        ...
        script = "if (document.getElementById('" + this.rbtType.ClientID + "_0').checked) {" +
            ...
            "{ alert ('" + string.Format(DataResources.MSGEI002, "ช่วงวันที่") + "'); return false; } else {" + Appz.OpenReportScript(Constant.Reports.StockInReturnToolsDay, scriptDay, false) + "} } " +
            ...
            "{ alert ('" + string.Format(DataResources.MSGEI002, "ช่วงเดือนและปี") + "'); return false; } else {" + Appz.OpenReportScript(Constant.Reports.StockInReturnToolsMonth, scriptMonth, false) + "} } " +
            "else {" +
            "if (document.getElementById('" + this.txtYearFrom.ClientID + "').value == '' || document.getElementById('" + this.txtYearTo.ClientID + "').value == '') " +
            "{ alert ('" + string.Format(DataResources.MSGEI002, "ช่วงปี") + "'); return false; } else {" + Appz.OpenReportScript(Constant.Reports.StockInReturnToolsYear, scriptYear, false) + "} } ";
    ...
    {
        base.OnInit(e);
        Appz.BuildCombo(this.cmbDivision, "V_STOCKINRETURNTOOLS_REPORT", "DIVISIONNAME", "DIVISION", "", "DIVISIONNAME", "ทั้งหมด", "0", true);
        Appz.BuildCombo(this.cmbMaterialClass, "V_STOCKINRETURNTOOLS_REPORT", "CLASSNAME", "MATERIALCLASS", "", "CLASSNAME", "ทั้งหมด", "0", true);
        Appz.BuildCombo(this.cmbMaterialMaster, "V_STOCKINRETURNTOOLS_REPORT", "MATERIALNAME", "MATERIALMASTER", "", "MATERIALNAME", "ทั้งหมด", "0", true);
