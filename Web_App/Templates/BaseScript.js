...
function chkAllBox1(cmb, name_f, name_b, name_c)
{
    var i = 2;
    var itxt = '00' + i;
    //alert(name_f + twonum(i) + name_b);
    while ( document.getElementById(name_f + itxt.substring(itxt.length - 2, itxt.length) + name_b) != null)
    {
        ...
        if (zctl.disabled == '') 
        {
            document.getElementById(name_f + itxt.substring(itxt.length - 2, itxt.length) + name_c).disabled = (cmb.checked ? '' : 'disabled');
           if (!cmb.checked) document.getElementById(name_f + itxt.substring(itxt.length - 2, itxt.length) + name_c).value=0; 
            zctl.checked = cmb.checked;
        }
        i++;
        itxt = '00' + i;
    }
