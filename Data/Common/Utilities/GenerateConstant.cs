...
namespace SHND.Data.Common
{
    public class GenerateConstant
    {
        ...
        public string DataSourceRequire { get { return string.Format(DataResources.MSGEI001, _DataSource); } }
        public string DatabaseRequire { get { return string.Format(DataResources.MSGEI001, _Database); } }
        public string UserIDRequire { get { return string.Format(DataResources.MSGEI001, _UserID); } }
        public string PasswordRequire { get { return string.Format(DataResources.MSGEI001, _Password); } }
        public string TableRequire { get { return string.Format(DataResources.MSGEI001, _TableName); } }
        public string ProjectNameRequire { get { return string.Format(DataResources.MSGEI001, _ProjectName); } }
        public string ClassRequire { get { return string.Format(DataResources.MSGEI001, _Class); } }
