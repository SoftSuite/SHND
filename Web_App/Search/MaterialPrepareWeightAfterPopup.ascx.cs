...
public partial class Search_MaterialPrepareWeightAfterPopup : System.Web.UI.UserControl
{
    ...
    public void Show(string materialclass, string existKeyList)
    {
    ...
    {
        MaterialPrepareFlow fFlow = new MaterialPrepareFlow();

        gvMain.DataSource = fFlow.GetMaterialMasterList(cmbMaterialClass.SelectedItem.Value, cmbMaterialGroup.SelectedItem.Value, txtName.Text.Trim(), txtExistKeyList.Text, "");
        gvMain.DataBind();
        pcBot.Update();
        pcTop.Update();
    }
