...
{
    /// <summary>
    /// Represents a transaction for PLANMATERIALDIVISION table.
    /// [Created by 127.0.0.1 on Febuary,11 2009]
    /// </summary>
    public class PlanMaterialDivisionDAL
    {

        public PlanMaterialDivisionDAL()
        {
        }

        #region Constant

        /// <summary>PLANMATERIALDIVISION</summary>
        private const string tableName = "PLANMATERIALDIVISION";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into PLANMATERIALDIVISION table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to PLANMATERIALDIVISION table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from PLANMATERIALDIVISION table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of PLANMATERIALDIVISION by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for PLANMATERIALDIVISION table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ADJQTY, CREATEBY, CREATEON, DIVISION, LOID, MENUQTY, PLANMATERIALITEM, PLANORDERDIVISION, REQQTY, STATUS) ";
                sql += "VALUES (";
                sql += DB.SetDouble(_ADJQTY) + ", ";
                ...
                sql += DB.SetDouble(_PLANMATERIALITEM) + ", ";
                sql += DB.SetDouble(_PLANORDERDIVISION) + ", ";
        ...
        /// <summary>
        /// Gets the update statement for PLANMATERIALDIVISION table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "ADJQTY = " + DB.SetDouble(_ADJQTY) + ", ";
                sql += "DIVISION = " + DB.SetDouble(_DIVISION) + ", ";
                sql += "MENUQTY = " + DB.SetDouble(_MENUQTY) + ", ";
                sql += "PLANMATERIALITEM = " + DB.SetDouble(_PLANMATERIALITEM) + ", ";
                sql += "PLANORDERDIVISION = " + DB.SetDouble(_PLANORDERDIVISION) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for PLANMATERIALDIVISION table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for PLANMATERIALDIVISION table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of PLANMATERIALDIVISION by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        public bool GetDataByConditions(double cDIVISION, double cPLANMATERIALITEM, OracleTransaction trans)
        {
            return doGetdata("DIVISION = " + DB.SetDouble(cDIVISION) + " AND PLANMATERIALITEM = " + DB.SetDouble(cPLANMATERIALITEM), trans);
        }
        ...
        public bool UpdateStatusByPlanOrder(double cPLANORDER, string cSTATUS, OracleTransaction trans)
        {
            ...
            try
            {
                affectedRow = DB.ExecuteNonQuery("UPDATE " + tableName + " SET STATUS = " + DB.SetString(cSTATUS) + " " +
                    "WHERE PLANMATERIALITEM IN (SELECT MI.LOID FROM PLANMATERIALITEM MI INNER JOIN PLANMATERIALCLASS MC ON MI.PLANMATERIALCLASS = MC.LOID WHERE MC.PLANORDER = " + DB.SetDouble(cPLANORDER) + ")", trans);
                ret = (affectedRow > 0);
                if (!ret) _error = DataResources.MSGEU001;
                _information = DataResources.MSGIU001;
            }
        ...
        public bool UpdateStatusByPlanMaterialItem(double cPLANMATERIALITEM, string cSTATUS, OracleTransaction trans)
        {
            bool ret = true;
            int affectedRow = 0;
            try
            {
                affectedRow = DB.ExecuteNonQuery("UPDATE " + tableName + " SET STATUS = " + DB.SetString(cSTATUS) + " WHERE PLANMATERIALITEM = " + DB.SetDouble(cPLANMATERIALITEM), trans);
                ret = (affectedRow > 0);
                if (!ret) _error = DataResources.MSGEU001;
                _information = DataResources.MSGIU001;
            }
