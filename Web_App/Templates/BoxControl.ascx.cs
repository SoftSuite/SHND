...
public partial class Templates_BoxControl : System.Web.UI.UserControl
{
...
");
    ...
    public void SetSource(DataTable zDt)
    {
        ...
        lstNoAuth.DataValueField = "ID";
        lstNoAuth.DataBind();
    }

    public void SetSource(DataTable zDt, string textField, string valueField)
    {
        lstNoAuth.DataSource = zDt;
        lstNoAuth.DataTextField = textField;
        lstNoAuth.DataValueField = valueField;
        lstNoAuth.DataBind();
    }
    ...
    public void SetDest(DataTable zDt)
    {
        ...
        lstAuth.DataValueField = "ID";
        lstAuth.DataBind();
    }

    public void SetDest(DataTable zDt, string textField, string valueField)
    {
        lstAuth.DataSource = zDt;
        lstAuth.DataTextField = textField;
        lstAuth.DataValueField = valueField;
        lstAuth.DataBind();
    }

    public Unit DestWidth
    {
        get { return lstNoAuth.Width; }
        set { lstNoAuth.Width = value; }
    }

    public Unit SourceWidth
    {
        get { return lstAuth.Width; }
        set { lstAuth.Width = value; }
    }
