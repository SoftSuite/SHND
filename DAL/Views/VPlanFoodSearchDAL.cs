...
{
    /// <summary>
    /// Represents a transaction for V_PLAN_FOOD_SEARCH view.
    /// [Created by 127.0.0.1 on January,27 2009]
    /// </summary>
    public class VPlanFoodSearchDAL
    {

        public VPlanFoodSearchDAL()
        {
        }

        #region Constant

        /// <summary>V_PLAN_FOOD_SEARCH</summary>
        private const string viewName = "V_PLAN_FOOD_SEARCH";
        ...
        /// <summary>
        /// Gets the select statement for V_PLAN_FOOD_SEARCH table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_PLAN_FOOD_SEARCH by specified condition is retrieved successfully.
        /// </summary>
        ...
        public DataTable GetDataListByConditions(string cNAME, double cPHASE, double cBUDGETYEAR, string cQTCODE, string cREFPRSAP, string cSTATUSRANKFROM, string cSTATUSRANKTO, string orderBy, OracleTransaction trans)
        {
            string whText = "";
