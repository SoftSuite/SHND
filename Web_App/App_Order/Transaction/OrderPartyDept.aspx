<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="OrderPartyDept.aspx.cs" Inherits="App_Order_Transaction_OrderPartyDept"  Title="SHND : Transaction - Food Order for Party" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
             <td>
                ...
                <uc1:ToolBarItemCtl ID="tbDelete" runat="server" ToobarTitle="ลบข้อมูลที่เลือก"  ToolbarImage="../../Images/icn_delete.png" ClientClick="return confirm('ต้องการลบข้อมูลที่เลือก ใช่หรือไม่?')" OnClick="tbDeleteClick" />
                    ...
                    <legend style="font-weight:bold">ค้นหา</legend>
                        <table cellspacing="0" cellpadding="0" border="0" width="700px">
                            ...
                            <tr style="height:24px">
                                ...
                                <td style="width:200px;"><asp:DropDownList ID="cmbStatusFrom" runat="server" Width="206px" CssClass="zComboBox"></asp:DropDownList></td>
                                <td style="width:30px; text-align:center;">ถึง</td>
                                <td style="width:200px;"><asp:DropDownList ID="cmbStatusTo" runat="server" Width="206px" CssClass="zComboBox"></asp:DropDownList></td>
                                <td>
            ...
            <td style="width:100%">
                ...
                <asp:GridView ID="gvMain" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="t_tablestyle" OnRowDataBound="gvMain_RowDataBound" OnSorting="gvMain_Sorting" AllowPaging="True" PageSize="20"  style="width:100%">
                    <Columns>
                        ...
                        <asp:BoundField HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy}" DataField="PARTYDATETIME" SortExpression="PARTYDATETIME" HeaderText="วันที่ต้องการ">
                            <ItemStyle Width="100px" HorizontalAlign="Center"></ItemStyle>
                            <HeaderStyle Width="100px" HorizontalAlign="Center"></HeaderStyle>
                        </asp:BoundField>
