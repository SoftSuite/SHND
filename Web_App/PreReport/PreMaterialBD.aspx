<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreMaterialBD.aspx.cs" Inherits="PreReport_PreMaterialBD" Title="SHND : Report - MaterialBD" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">รายงานสรุปจำนวนการเบิก Blenderize Diet
            </td>
        </tr>
        <tr>
            <td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600">
                    <tr style="height:24px">
                        <td style="width:130px; padding-right:10px" align="right">
                            ชนิดอาหาร :</td>
                        <td>
                            <asp:DropDownList ID="cmbMaterial" runat="server" CssClass="zComboBox" Width="132px">
                            </asp:DropDownList></td>
                    </tr> 
                    <tr style="height:24px">
