<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreMaterialUseQty.aspx.cs" Inherits="PreReport_PreMaterialUseQty"  Title="SHND : Report - Material Use Qty" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">รายงานสรุปจำนวนการใช้วัตถุดิบ
            </td>
        </tr>
        <tr>
            <td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600">
                    ...
                    <tr style="height:24px">
                        <td style="width:130px; padding-right:10px; height: 24px;" align="right">
                            วัตถุดิบ :</td>
                        <td style="height: 24px">
                            <asp:DropDownList ID="cmbContainer" runat="server" CssClass="zComboBox" Width="326px" OnSelectedIndexChanged="cmbContainer_SelectedIndexChanged" AutoPostBack="True">
