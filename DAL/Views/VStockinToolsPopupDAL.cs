...
{
    /// <summary>
    /// Represents a transaction for V_STOCKIN_TOOLS_POPUP view.
    /// [Created by 127.0.0.1 on Febuary,27 2009]
    /// </summary>
    public class VStockinToolsPopupDAL
    {

        public VStockinToolsPopupDAL()
        {
        }

        #region Constant

        /// <summary>V_STOCKIN_TOOLS_POPUP</summary>
        private const string viewName = "V_STOCKIN_TOOLS_POPUP";
        ...
        /// <summary>
        /// Gets the select statement for V_STOCKIN_TOOLS_POPUP table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of V_STOCKIN_TOOLS_POPUP by specified condition is retrieved successfully.
        /// </summary>
