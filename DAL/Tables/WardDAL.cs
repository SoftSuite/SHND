...
{
    /// <summary>
    /// Represents a transaction for WARD table.
    ...
    public class WardDAL
    {
        ...
        private const string tableName = "WARD";
        ...
        public string ISLOCKCUTOFFTIME
        {
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into WARD table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to WARD table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from WARD table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of WARD by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of WARD by specified CODE key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of WARD by specified NAME key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of WARD by specified ABBNAME key is retrieved successfully.
        /// </summary>
        /// <param name="cNAME">The NAME key.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        /// <summary>
        /// Gets the insert statement for WARD table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ABBNAME, ACTIVE, BEDQTY, CODE, CREATEBY, CREATEON, DEFAULTFOODTYPE, LOID, NAME, SAPCODE, ISLOCKCUTOFFTIME) ";
                sql += "VALUES (";
                sql += DB.SetString(_ABBNAME) + ", ";
                sql += DB.SetString(_ACTIVE) + ", ";
                sql += DB.SetDouble(_BEDQTY) + ", ";
                sql += DB.SetString(_CODE) + ", ";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDouble(_DEFAULTFOODTYPE) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetString(_NAME) + ", ";
                sql += DB.SetString(_SAPCODE) + ", ";
                sql += DB.SetString(_ISLOCKCUTOFFTIME) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for WARD table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "ISLOCKCUTOFFTIME = " + DB.SetString(_ISLOCKCUTOFFTIME) + ", ";
                sql += "BEDQTY = " + DB.SetDouble(_BEDQTY) + ", ";
                sql += "CODE = " + DB.SetString(_CODE) + ", ";
                sql += "DEFAULTFOODTYPE = " + DB.SetDouble(_DEFAULTFOODTYPE) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for WARD table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for WARD table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of WARD by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["ISLOCKCUTOFFTIME"])) _ISLOCKCUTOFFTIME = zRdr["ISLOCKCUTOFFTIME"].ToString();
        ...
        {
            string sql = "SELECT * FROM WARD WHERE LOID = '" + ward.ToString() + "' ";

            DataTable dt = DB.ExecuteTable(sql);
            string isLock = "";
            if (dt.Rows.Count > 0)
            {
                isLock = dt.Rows[0]["ISLOCKCUTOFFTIME"].ToString();
            }
