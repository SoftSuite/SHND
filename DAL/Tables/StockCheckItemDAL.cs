...
{
    /// <summary>
    /// Represents a transaction for STOCKCHECKITEM table.
    /// [Created by 127.0.0.1 on Febuary,12 2009]
    /// </summary>
    public class StockCheckItemDAL
    {

        public StockCheckItemDAL()
        {
        }

        #region Constant

        /// <summary>STOCKCHECKITEM</summary>
        private const string tableName = "STOCKCHECKITEM";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into STOCKCHECKITEM table successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to STOCKCHECKITEM table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from STOCKCHECKITEM table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of STOCKCHECKITEM by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Gets the insert statement for STOCKCHECKITEM table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(COUNTQTY, CREATEBY, CREATEON, IMPROVEQTY, ISIMPROVE, LOID, LOTNO, MATERIALMASTER, STOCKCHECK, STOCKQTY) ";
                sql += "VALUES (";
                sql += DB.SetDouble(_COUNTQTY) + ", ";
                sql += DB.SetString(_CREATEBY) + ", ";
                sql += DB.SetDateTime(_CREATEON) + ", ";
                sql += DB.SetDouble(_IMPROVEQTY) + ", ";
                sql += DB.SetString(_ISIMPROVE) + ", ";
                sql += DB.SetDouble(_LOID) + ", ";
                sql += DB.SetString(_LOTNO) + ", ";
                sql += DB.SetDouble(_MATERIALMASTER) + ", ";
                sql += DB.SetDouble(_STOCKCHECK) + ", ";
                sql += DB.SetDouble(_STOCKQTY) + " ";
                sql += ")";
                return sql;
            }
        }
        ...
        /// <summary>
        /// Gets the update statement for STOCKCHECKITEM table.
        /// </summary>
        private string sql_update
        {
            get
            {
                ...
                sql += "COUNTQTY = " + DB.SetDouble(_COUNTQTY) + ", ";
                sql += "IMPROVEQTY = " + DB.SetDouble(_IMPROVEQTY) + ", ";
                sql += "ISIMPROVE = " + DB.SetString(_ISIMPROVE) + ", ";
                sql += "LOTNO = " + DB.SetString(_LOTNO) + ", ";
                sql += "MATERIALMASTER = " + DB.SetDouble(_MATERIALMASTER) + ", ";
                sql += "STOCKCHECK = " + DB.SetDouble(_STOCKCHECK) + ", ";
                sql += "STOCKQTY = " + DB.SetDouble(_STOCKQTY) + ", ";
        ...
        /// <summary>
        /// Gets the delete statement for STOCKCHECKITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for STOCKCHECKITEM table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of STOCKCHECKITEM by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        private string sql_field
        {
            get
            {
                string sql = "SELECT SC.LOID SCLOID, MM.CODE MMCODE, MM.NAME MMNAME, U.THNAME UNAME, ";
                       sql += " SCI.LOID SCILOID, NVL(SCI.COUNTQTY,0) COUNTQTY ";
                       sql += " FROM STOCKCHECK SC INNER JOIN STOCKCHECKITEM SCI ON SCI.STOCKCHECK = SC.LOID ";
                       sql += " INNER JOIN MATERIALMASTER MM ON MM.LOID = SCI.MATERIALMASTER ";
                       sql += " INNER JOIN UNIT U ON U.LOID = MM.UNIT  ";
                return sql;
            }
        }


        public bool GetDataByStockCheck(double cLOID, OracleTransaction trans)
        {
            return doGetdata("STOCKCHECK = " + DB.SetDouble(cLOID) + " ", trans);
        }

        public bool DeleteByStockChek(double cLOID, OracleTransaction trans)
        {
            return doDelete(" STOCKCHECK = " + DB.SetDouble(cLOID) + " ", trans);
        }
