...
{
    /// <summary>
    /// Represents a transaction for MILKCATEGORY table.
    /// [Created by 127.0.0.1 on December,30 2008]
    /// </summary>
    public class MilkCategoryDAL
    {

        public MilkCategoryDAL()
        {
        }

        #region Constant

        /// <summary>MILKCATEGORY</summary>
        private const string tableName = "MILKCATEGORY";
        ...
        /// <summary>
        /// Returns an indication whether the current data is inserted into MILKCATEGORY table successfully.
        /// </summary>
 ...
 //           _LOID = DB.GetNextID(TableName, trans);
            _CODE = DB.GetRunningCode("MILKCATEGORY", "CODE");
            _CREATEBY = userID;
        ...
        /// <summary>
        /// Returns an indication whether the current data is updated to MILKCATEGORY table successfully.
        /// </summary>
        /// <param name="userID">The current user.</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the current data is deleted from MILKCATEGORY table successfully.
        /// </summary>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        ...
        /// <summary>
        /// Returns an indication whether the record of MILKCATEGORY by specified LOID key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of MILKCATEGORY by specified CODE key is retrieved successfully.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of MILKCATEGORY by specified NAME key is retrieved successfully.
        /// </summary>
        ...
        public DataTable GetDataListByCondition(string orderBy, OracleTransaction trans)
        {
            //build where clause

            return GetDataList("", orderBy, trans);
        }
        ...
        /// <summary>
        /// Gets the insert statement for MILKCATEGORY table.
        /// </summary>
        private string sql_insert
        {
            get
            {
                string sql = "INSERT INTO " + tableName + "(ACTIVE, CODE, CREATEBY, CREATEON, ISSPECIFIC, NAME) ";
                sql += "VALUES (";
        ...
        /// <summary>
        /// Gets the update statement for MILKCATEGORY table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the delete statement for MILKCATEGORY table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the select statement for MILKCATEGORY table.
        /// </summary>
        ...
        /// <summary>
        /// Returns an indication whether the record of MILKCATEGORY by specified condition is retrieved successfully.
        /// </summary>
        /// <param name="whText">The condition specify the deleting record(s).</param>
        /// <param name="trans">The System.Data.OracleClient.OracleTransaction used by this System.Data.OracleClient.OracleCommand.</param>
        /// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        private string sql_specific
        {
            get
            {
                string sql = "SELECT ISSPECIFIC FROM " + tableName + " ";
                return sql;
            }
        }

        public string GetSpecificMilk(string whereClause, string orderBy, OracleTransaction trans)
        {
            return DB.ExecuteScalar(sql_specific + (whereClause == "" ? "" : "WHERE " + whereClause + " ") + (orderBy == "" ? "" : "ORDER BY " + DB.SetSortString(orderBy)), trans).ToString();
        }
