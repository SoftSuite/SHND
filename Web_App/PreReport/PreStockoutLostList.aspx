<%@ Page Language="C#" MasterPageFile="~/Templates/Page1.master" AutoEventWireup="true" CodeFile="PreStockoutLostList.aspx.cs" Inherits="PreReport_PreStockoutLostList" Title="SHND : Report - Stockout Lost Material" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">
                รายงานสรุปรายการวัสดุอาหารที่จำหน่ายออกเป็นของเสีย</td>
        </tr>
        <tr>
            <td>
                 ...
                 <tr style="height:10px"></tr>
                    <tr style="height:24px">
                        <td style="width:130px; padding-right:10px; height: 23px;" align="right">
                            หน่วยงาน :</td>
                        <td style="height: 23px" colspan="3"><asp:DropDownList ID="cmbDivision" runat="server" CssClass="zComboBox" Width="312px">
                        </asp:DropDownList></td>
                    </tr>  
                    <tr style="height: 24px">
